...
trait BusinessentityaddressFields {
  ...
  def compositeIdIn(compositeIds: Array[BusinessentityaddressId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[BusinessentityaddressId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[BusinessentityaddressId](addressid)(_.addressid)(using as[Array[AddressId]](using ToParameterValue(null, AddressId.arrayToStatement), adventureworks.arrayParameterMetaData(using AddressId.parameterMetadata)), implicitly), TuplePart[BusinessentityaddressId](addresstypeid)(_.addresstypeid)(using as[Array[AddresstypeId]](using ToParameterValue(null, AddresstypeId.arrayToStatement), adventureworks.arrayParameterMetaData(using AddresstypeId.parameterMetadata)), implicitly))
