...
trait BusinessentitycontactFields {
  ...
  def compositeIdIn(compositeIds: Array[BusinessentitycontactId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[BusinessentitycontactId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[BusinessentitycontactId](personid)(_.personid)(using as[Array[BusinessentityId]](using ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[BusinessentitycontactId](contacttypeid)(_.contacttypeid)(using as[Array[ContacttypeId]](using ToParameterValue(null, ContacttypeId.arrayToStatement), adventureworks.arrayParameterMetaData(using ContacttypeId.parameterMetadata)), implicitly))
