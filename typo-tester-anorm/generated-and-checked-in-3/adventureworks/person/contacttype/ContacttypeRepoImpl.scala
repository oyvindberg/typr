...
class ContacttypeRepoImpl extends ContacttypeRepo {
  ...
  def deleteById(contacttypeid: ContacttypeId)(using c: Connection): Boolean = SQL"""delete from "person"."contacttype" where "contacttypeid" = ${ParameterValue(contacttypeid, null, ContacttypeId.toStatement)}""".executeUpdate() > 0
