...
trait SalesorderheadersalesreasonFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesorderheadersalesreasonId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SalesorderheadersalesreasonId](salesorderid)(_.salesorderid)(using as[Array[SalesorderheaderId]](using ToParameterValue(null, SalesorderheaderId.arrayToStatement), adventureworks.arrayParameterMetaData(using SalesorderheaderId.parameterMetadata)), implicitly), TuplePart[SalesorderheadersalesreasonId](salesreasonid)(_.salesreasonid)(using as[Array[SalesreasonId]](using ToParameterValue(null, SalesreasonId.arrayToStatement), adventureworks.arrayParameterMetaData(using SalesreasonId.parameterMetadata)), implicitly))
