...
trait CountryregioncurrencyFields {
  ...
  def compositeIdIn(compositeIds: Array[CountryregioncurrencyId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[CountryregioncurrencyId](countryregioncode)(_.countryregioncode)(using as[Array[CountryregionId]](using ToParameterValue(null, CountryregionId.arrayToStatement), adventureworks.arrayParameterMetaData(using CountryregionId.parameterMetadata)), implicitly), TuplePart[CountryregioncurrencyId](currencycode)(_.currencycode)(using as[Array[CurrencyId]](using ToParameterValue(null, CurrencyId.arrayToStatement), adventureworks.arrayParameterMetaData(using CurrencyId.parameterMetadata)), implicitly))
