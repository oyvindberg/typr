...
trait PersoncreditcardFields {
  ...
  def compositeIdIn(compositeIds: Array[PersoncreditcardId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[PersoncreditcardId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[PersoncreditcardId](creditcardid)(_.creditcardid)(using as[Array[/* user-picked */ CustomCreditcardId]](using ToParameterValue(null, CustomCreditcardId.arrayToStatement), adventureworks.arrayParameterMetaData(using CustomCreditcardId.parameterMetadata)), implicitly))
