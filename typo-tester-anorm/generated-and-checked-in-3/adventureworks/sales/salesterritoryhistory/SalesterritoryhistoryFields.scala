...
trait SalesterritoryhistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesterritoryhistoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SalesterritoryhistoryId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[SalesterritoryhistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDateTime]](using ToParameterValue(null, TypoLocalDateTime.arrayToStatement), adventureworks.arrayParameterMetaData(using TypoLocalDateTime.parameterMetadata)), implicitly), TuplePart[SalesterritoryhistoryId](territoryid)(_.territoryid)(using as[Array[SalesterritoryId]](using ToParameterValue(null, SalesterritoryId.arrayToStatement), adventureworks.arrayParameterMetaData(using SalesterritoryId.parameterMetadata)), implicitly))
