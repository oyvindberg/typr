...
trait SalesorderdetailFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesorderdetailId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SalesorderdetailId](salesorderid)(_.salesorderid)(using as[Array[SalesorderheaderId]](using ToParameterValue(null, SalesorderheaderId.arrayToStatement), adventureworks.arrayParameterMetaData(using SalesorderheaderId.parameterMetadata)), implicitly), TuplePart[SalesorderdetailId](salesorderdetailid)(_.salesorderdetailid)(using as[Array[Int]](using ToParameterValue(null, adventureworks.IntArrayToStatement), adventureworks.arrayParameterMetaData(using ParameterMetaData.IntParameterMetaData)), implicitly))
