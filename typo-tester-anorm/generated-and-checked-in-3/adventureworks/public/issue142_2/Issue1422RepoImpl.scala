...
class Issue1422RepoImpl extends Issue1422Repo {
  ...
  def deleteById(tabellkode: Issue142Id)(using c: Connection): Boolean = SQL"""delete from "public"."issue142_2" where "tabellkode" = ${ParameterValue(tabellkode, null, Issue142Id.toStatement)}""".executeUpdate() > 0
