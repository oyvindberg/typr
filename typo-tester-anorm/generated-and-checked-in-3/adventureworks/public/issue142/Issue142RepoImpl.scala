...
class Issue142RepoImpl extends Issue142Repo {
  ...
  def deleteById(tabellkode: Issue142Id)(using c: Connection): Boolean = SQL"""delete from "public"."issue142" where "tabellkode" = ${ParameterValue(tabellkode, null, Issue142Id.toStatement)}""".executeUpdate() > 0
