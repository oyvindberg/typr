...
trait ProductdocumentFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductdocumentId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductdocumentId](productid)(_.productid)(using as[Array[ProductId]](using ToParameterValue(null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductdocumentId](documentnode)(_.documentnode)(using as[Array[DocumentId]](using ToParameterValue(null, DocumentId.arrayToStatement), adventureworks.arrayParameterMetaData(using DocumentId.parameterMetadata)), implicitly))
