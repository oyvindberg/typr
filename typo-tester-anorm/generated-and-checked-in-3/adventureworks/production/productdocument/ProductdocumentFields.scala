...
trait ProductdocumentFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductdocumentId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductdocumentId](productid)(_.productid)(using as[Array[ProductId], Required](using ToParameterValue(null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductdocumentId](documentnode)(_.documentnode)(using as[Array[DocumentId], Required](using ToParameterValue(null, DocumentId.arrayToStatement), adventureworks.arrayParameterMetaData(using DocumentId.parameterMetadata)), implicitly))
