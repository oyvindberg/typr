...
case class TransactionhistoryarchiveRepoMock(
  ...
  def deleteById(transactionid: TransactionhistoryarchiveId)(using c: Connection): Boolean = map.remove(transactionid).isDefined

  def deleteByIds(transactionids: Array[TransactionhistoryarchiveId])(using c: Connection): Int = transactionids.map(id => map.remove(id)).count(_.isDefined)
  ...
  def insert(unsaved: TransactionhistoryarchiveRowUnsaved)(using c: Connection): TransactionhistoryarchiveRow = insert(toRow(unsaved))
  ...
  def selectAll(using c: Connection): List[TransactionhistoryarchiveRow] = map.values.toList

  def selectById(transactionid: TransactionhistoryarchiveId)(using c: Connection): Option[TransactionhistoryarchiveRow] = map.get(transactionid)

  def selectByIds(transactionids: Array[TransactionhistoryarchiveId])(using c: Connection): List[TransactionhistoryarchiveRow] = transactionids.flatMap(map.get).toList
