...
trait ProductmodelproductdescriptioncultureFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelproductdescriptioncultureId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelproductdescriptioncultureId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId], Required](using ToParameterValue(null, ProductmodelId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductmodelId.parameterMetadata)), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](productdescriptionid)(_.productdescriptionid)(using as[Array[ProductdescriptionId], Required](using ToParameterValue(null, ProductdescriptionId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductdescriptionId.parameterMetadata)), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](cultureid)(_.cultureid)(using as[Array[CultureId], Required](using ToParameterValue(null, CultureId.arrayToStatement), adventureworks.arrayParameterMetaData(using CultureId.parameterMetadata)), implicitly))
