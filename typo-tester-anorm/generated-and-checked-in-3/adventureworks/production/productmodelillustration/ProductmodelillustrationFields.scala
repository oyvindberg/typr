...
trait ProductmodelillustrationFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelillustrationId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelillustrationId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId]](using ToParameterValue(null, ProductmodelId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductmodelId.parameterMetadata)), implicitly), TuplePart[ProductmodelillustrationId](illustrationid)(_.illustrationid)(using as[Array[IllustrationId]](using ToParameterValue(null, IllustrationId.arrayToStatement), adventureworks.arrayParameterMetaData(using IllustrationId.parameterMetadata)), implicitly))
