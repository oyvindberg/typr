...
trait ProductinventoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductinventoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductinventoryId](productid)(_.productid)(using as[Array[ProductId]](using ToParameterValue(null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductinventoryId](locationid)(_.locationid)(using as[Array[LocationId]](using ToParameterValue(null, LocationId.arrayToStatement), adventureworks.arrayParameterMetaData(using LocationId.parameterMetadata)), implicitly))
