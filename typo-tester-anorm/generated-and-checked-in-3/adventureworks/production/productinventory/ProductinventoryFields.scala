...
trait ProductinventoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductinventoryId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductinventoryId](productid)(_.productid)(using as[Array[ProductId], Required](using ToParameterValue(null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductinventoryId](locationid)(_.locationid)(using as[Array[LocationId], Required](using ToParameterValue(null, LocationId.arrayToStatement), adventureworks.arrayParameterMetaData(using LocationId.parameterMetadata)), implicitly))
