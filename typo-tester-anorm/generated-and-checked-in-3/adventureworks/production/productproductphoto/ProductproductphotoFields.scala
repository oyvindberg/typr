...
trait ProductproductphotoFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductproductphotoId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductproductphotoId](productid)(_.productid)(using as[Array[ProductId]](using ToParameterValue(null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductproductphotoId](productphotoid)(_.productphotoid)(using as[Array[ProductphotoId]](using ToParameterValue(null, ProductphotoId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductphotoId.parameterMetadata)), implicitly))
