...
trait ProductproductphotoFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductproductphotoId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductproductphotoId](productid)(_.productid)(using as[Array[ProductId], Required](using ToParameterValue(null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductproductphotoId](productphotoid)(_.productphotoid)(using as[Array[ProductphotoId], Required](using ToParameterValue(null, ProductphotoId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductphotoId.parameterMetadata)), implicitly))
