...
case class ProductproductphotoRepoMock(
  ...
  def deleteById(compositeId: ProductproductphotoId)(using c: Connection): Boolean = map.remove(compositeId).isDefined

  def deleteByIds(compositeIds: Array[ProductproductphotoId])(using c: Connection): Int = compositeIds.map(id => map.remove(id)).count(_.isDefined)
  ...
  def insert(unsaved: ProductproductphotoRowUnsaved)(using c: Connection): ProductproductphotoRow = insert(toRow(unsaved))
  ...
  def selectAll(using c: Connection): List[ProductproductphotoRow] = map.values.toList

  def selectById(compositeId: ProductproductphotoId)(using c: Connection): Option[ProductproductphotoRow] = map.get(compositeId)

  def selectByIds(compositeIds: Array[ProductproductphotoId])(using c: Connection): List[ProductproductphotoRow] = compositeIds.flatMap(map.get).toList
