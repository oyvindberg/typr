...
class ProductreviewRepoImpl extends ProductreviewRepo {
  ...
  def deleteById(productreviewid: ProductreviewId)(using c: Connection): Boolean = SQL"""delete from "production"."productreview" where "productreviewid" = ${ParameterValue(productreviewid, null, ProductreviewId.toStatement)}""".executeUpdate() > 0
