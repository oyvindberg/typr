...
trait EmployeedepartmenthistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[EmployeedepartmenthistoryId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[EmployeedepartmenthistoryId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId], Required](using ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[EmployeedepartmenthistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDate], Required](using ToParameterValue(null, TypoLocalDate.arrayToStatement), adventureworks.arrayParameterMetaData(using TypoLocalDate.parameterMetadata)), implicitly), TuplePart[EmployeedepartmenthistoryId](departmentid)(_.departmentid)(using as[Array[DepartmentId], Required](using ToParameterValue(null, DepartmentId.arrayToStatement), adventureworks.arrayParameterMetaData(using DepartmentId.parameterMetadata)), implicitly), TuplePart[EmployeedepartmenthistoryId](shiftid)(_.shiftid)(using as[Array[ShiftId], Required](using ToParameterValue(null, ShiftId.arrayToStatement), adventureworks.arrayParameterMetaData(using ShiftId.parameterMetadata)), implicitly))
