...
trait EmployeedepartmenthistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[EmployeedepartmenthistoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[EmployeedepartmenthistoryId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[EmployeedepartmenthistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDate]](using ToParameterValue(null, TypoLocalDate.arrayToStatement), adventureworks.arrayParameterMetaData(using TypoLocalDate.parameterMetadata)), implicitly), TuplePart[EmployeedepartmenthistoryId](departmentid)(_.departmentid)(using as[Array[DepartmentId]](using ToParameterValue(null, DepartmentId.arrayToStatement), adventureworks.arrayParameterMetaData(using DepartmentId.parameterMetadata)), implicitly), TuplePart[EmployeedepartmenthistoryId](shiftid)(_.shiftid)(using as[Array[ShiftId]](using ToParameterValue(null, ShiftId.arrayToStatement), adventureworks.arrayParameterMetaData(using ShiftId.parameterMetadata)), implicitly))
