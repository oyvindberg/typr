...
case class EmployeedepartmenthistoryRepoMock(
  ...
  def deleteById(compositeId: EmployeedepartmenthistoryId)(using c: Connection): Boolean = map.remove(compositeId).isDefined

  def deleteByIds(compositeIds: Array[EmployeedepartmenthistoryId])(using c: Connection): Int = compositeIds.map(id => map.remove(id)).count(_.isDefined)
  ...
  def insert(unsaved: EmployeedepartmenthistoryRowUnsaved)(using c: Connection): EmployeedepartmenthistoryRow = insert(toRow(unsaved))
  ...
  def selectAll(using c: Connection): List[EmployeedepartmenthistoryRow] = map.values.toList

  def selectById(compositeId: EmployeedepartmenthistoryId)(using c: Connection): Option[EmployeedepartmenthistoryRow] = map.get(compositeId)

  def selectByIds(compositeIds: Array[EmployeedepartmenthistoryId])(using c: Connection): List[EmployeedepartmenthistoryRow] = compositeIds.flatMap(map.get).toList
