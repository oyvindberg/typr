...
class TitleRepoImpl extends TitleRepo {
  ...
  def deleteById(code: TitleId)(implicit c: Connection): Boolean = SQL"""delete from "public"."title" where "code" = ${ParameterValue(code, null, TitleId.toStatement)}""".executeUpdate() > 0
