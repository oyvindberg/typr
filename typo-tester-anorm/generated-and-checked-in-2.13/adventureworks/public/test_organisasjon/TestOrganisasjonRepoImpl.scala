...
class TestOrganisasjonRepoImpl extends TestOrganisasjonRepo {
  ...
  def deleteById(organisasjonskode: TestOrganisasjonId)(implicit c: Connection): Boolean = SQL"""delete from "public"."test_organisasjon" where "organisasjonskode" = ${ParameterValue(organisasjonskode, null, TestOrganisasjonId.toStatement)}""".executeUpdate() > 0
