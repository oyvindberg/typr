...
class ProductreviewRepoImpl() : ProductreviewRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"production\".\"productreview\" where \"productreviewid\" = "), Fragment.encode(ProductreviewId.pgType, productreviewid), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int4, unsaved.rating), Fragment.lit("::int4")))
    columns.add(Fragment.lit("\"comments\""))
    values.add(interpolate(Fragment.encode(PgTypes.text.nullable(), unsaved.comments), Fragment.lit("")))
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into \"production\".\"productreview\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"productreviewid\", \"productid\", \"reviewername\", \"reviewdate\", \"emailaddress\", \"rating\", \"comments\", \"modifieddate\"\n"))
  ...
  override fun selectAll(c: Connection): List<ProductreviewRow> = interpolate(Fragment.lit("select \"productreviewid\", \"productid\", \"reviewername\", \"reviewdate\", \"emailaddress\", \"rating\", \"comments\", \"modifieddate\"\nfrom \"production\".\"productreview\"\n")).query(ProductreviewRow._rowParser.all()).runUnchecked(c)

  override fun selectById(
    productreviewid: ProductreviewId,
    c: Connection
  ): ProductreviewRow? = interpolate(Fragment.lit("select \"productreviewid\", \"productid\", \"reviewername\", \"reviewdate\", \"emailaddress\", \"rating\", \"comments\", \"modifieddate\"\nfrom \"production\".\"productreview\"\nwhere \"productreviewid\" = "), Fragment.encode(ProductreviewId.pgType, productreviewid), Fragment.lit("")).query(ProductreviewRow._rowParser.first()).runUnchecked(c)

  override fun selectByIds(
    productreviewids: Array<ProductreviewId>,
    c: Connection
  ): List<ProductreviewRow> = interpolate(Fragment.lit("select \"productreviewid\", \"productid\", \"reviewername\", \"reviewdate\", \"emailaddress\", \"rating\", \"comments\", \"modifieddate\"\nfrom \"production\".\"productreview\"\nwhere \"productreviewid\" = ANY("), Fragment.encode(ProductreviewId.pgTypeArray, productreviewids), Fragment.lit(")")).query(ProductreviewRow._rowParser.all()).runUnchecked(c)
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<ProductreviewRow>,
    c: Connection
  ): List<ProductreviewRow> = interpolate(Fragment.lit("insert into \"production\".\"productreview\"(\"productreviewid\", \"productid\", \"reviewername\", \"reviewdate\", \"emailaddress\", \"rating\", \"comments\", \"modifieddate\")\nvalues (?::int4, ?::int4, ?::varchar, ?::timestamp, ?, ?::int4, ?, ?::timestamp)\non conflict (\"productreviewid\")\ndo update set\n  \"productid\" = EXCLUDED.\"productid\",\n\"reviewername\" = EXCLUDED.\"reviewername\",\n\"reviewdate\" = EXCLUDED.\"reviewdate\",\n\"emailaddress\" = EXCLUDED.\"emailaddress\",\n\"rating\" = EXCLUDED.\"rating\",\n\"comments\" = EXCLUDED.\"comments\",\n\"modifieddate\" = EXCLUDED.\"modifieddate\"\nreturning \"productreviewid\", \"productid\", \"reviewername\", \"reviewdate\", \"emailaddress\", \"rating\", \"comments\", \"modifieddate\""))
