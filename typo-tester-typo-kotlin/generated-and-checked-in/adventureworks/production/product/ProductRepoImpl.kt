...
class ProductRepoImpl() : ProductRepo {
  ...
  override fun deleteById(
    productid: ProductId,
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"production\".\"product\" where \"productid\" = "), Fragment.encode(ProductId.pgType, productid), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(interpolate(Fragment.encode(PgTypes.text.nullable(), unsaved.color), Fragment.lit("")))
    columns.add(Fragment.lit("\"safetystocklevel\""))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int2, unsaved.safetystocklevel), Fragment.lit("::int2")))
    columns.add(Fragment.lit("\"reorderpoint\""))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int2, unsaved.reorderpoint), Fragment.lit("::int2")))
    ...
    values.add(interpolate(Fragment.encode(PgTypes.text.nullable(), unsaved.size), Fragment.lit("")))
    columns.add(Fragment.lit("\"sizeunitmeasurecode\""))
    values.add(interpolate(Fragment.encode(UnitmeasureId.pgType.nullable(), unsaved.sizeunitmeasurecode), Fragment.lit("::bpchar")))
    columns.add(Fragment.lit("\"weightunitmeasurecode\""))
    values.add(interpolate(Fragment.encode(UnitmeasureId.pgType.nullable(), unsaved.weightunitmeasurecode), Fragment.lit("::bpchar")))
    columns.add(Fragment.lit("\"weight\""))
    values.add(interpolate(Fragment.encode(PgTypes.numeric.nullable(), unsaved.weight), Fragment.lit("::numeric")))
    columns.add(Fragment.lit("\"daystomanufacture\""))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int4, unsaved.daystomanufacture), Fragment.lit("::int4")))
    columns.add(Fragment.lit("\"productline\""))
    values.add(interpolate(Fragment.encode(PgTypes.bpchar.nullable(), unsaved.productline), Fragment.lit("::bpchar")))
    columns.add(Fragment.lit("\"class\""))
    values.add(interpolate(Fragment.encode(PgTypes.bpchar.nullable(), unsaved.`class`), Fragment.lit("::bpchar")))
    columns.add(Fragment.lit("\"style\""))
    values.add(interpolate(Fragment.encode(PgTypes.bpchar.nullable(), unsaved.style), Fragment.lit("::bpchar")))
    columns.add(Fragment.lit("\"productsubcategoryid\""))
    values.add(interpolate(Fragment.encode(ProductsubcategoryId.pgType.nullable(), unsaved.productsubcategoryid), Fragment.lit("::int4")))
    columns.add(Fragment.lit("\"productmodelid\""))
    values.add(interpolate(Fragment.encode(ProductmodelId.pgType.nullable(), unsaved.productmodelid), Fragment.lit("::int4")))
    ...
    values.add(interpolate(Fragment.encode(PgTypes.timestamp.nullable(), unsaved.sellenddate), Fragment.lit("::timestamp")))
    columns.add(Fragment.lit("\"discontinueddate\""))
    values.add(interpolate(Fragment.encode(PgTypes.timestamp.nullable(), unsaved.discontinueddate), Fragment.lit("::timestamp")))
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into \"production\".\"product\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"productid\", \"name\", \"productnumber\", \"makeflag\", \"finishedgoodsflag\", \"color\", \"safetystocklevel\", \"reorderpoint\", \"standardcost\", \"listprice\", \"size\", \"sizeunitmeasurecode\", \"weightunitmeasurecode\", \"weight\", \"daystomanufacture\", \"productline\", \"class\", \"style\", \"productsubcategoryid\", \"productmodelid\", \"sellstartdate\", \"sellenddate\", \"discontinueddate\", \"rowguid\", \"modifieddate\"\n"))
  ...
  override fun selectAll(c: Connection): List<ProductRow> = interpolate(Fragment.lit("select \"productid\", \"name\", \"productnumber\", \"makeflag\", \"finishedgoodsflag\", \"color\", \"safetystocklevel\", \"reorderpoint\", \"standardcost\", \"listprice\", \"size\", \"sizeunitmeasurecode\", \"weightunitmeasurecode\", \"weight\", \"daystomanufacture\", \"productline\", \"class\", \"style\", \"productsubcategoryid\", \"productmodelid\", \"sellstartdate\", \"sellenddate\", \"discontinueddate\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"product\"\n")).query(ProductRow._rowParser.all()).runUnchecked(c)

  override fun selectById(
    productid: ProductId,
    c: Connection
  ): ProductRow? = interpolate(Fragment.lit("select \"productid\", \"name\", \"productnumber\", \"makeflag\", \"finishedgoodsflag\", \"color\", \"safetystocklevel\", \"reorderpoint\", \"standardcost\", \"listprice\", \"size\", \"sizeunitmeasurecode\", \"weightunitmeasurecode\", \"weight\", \"daystomanufacture\", \"productline\", \"class\", \"style\", \"productsubcategoryid\", \"productmodelid\", \"sellstartdate\", \"sellenddate\", \"discontinueddate\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"product\"\nwhere \"productid\" = "), Fragment.encode(ProductId.pgType, productid), Fragment.lit("")).query(ProductRow._rowParser.first()).runUnchecked(c)

  override fun selectByIds(
    productids: Array<ProductId>,
    c: Connection
  ): List<ProductRow> = interpolate(Fragment.lit("select \"productid\", \"name\", \"productnumber\", \"makeflag\", \"finishedgoodsflag\", \"color\", \"safetystocklevel\", \"reorderpoint\", \"standardcost\", \"listprice\", \"size\", \"sizeunitmeasurecode\", \"weightunitmeasurecode\", \"weight\", \"daystomanufacture\", \"productline\", \"class\", \"style\", \"productsubcategoryid\", \"productmodelid\", \"sellstartdate\", \"sellenddate\", \"discontinueddate\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"product\"\nwhere \"productid\" = ANY("), Fragment.encode(ProductId.pgTypeArray, productids), Fragment.lit(")")).query(ProductRow._rowParser.all()).runUnchecked(c)
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<ProductRow>,
    c: Connection
  ): List<ProductRow> = interpolate(Fragment.lit("insert into \"production\".\"product\"(\"productid\", \"name\", \"productnumber\", \"makeflag\", \"finishedgoodsflag\", \"color\", \"safetystocklevel\", \"reorderpoint\", \"standardcost\", \"listprice\", \"size\", \"sizeunitmeasurecode\", \"weightunitmeasurecode\", \"weight\", \"daystomanufacture\", \"productline\", \"class\", \"style\", \"productsubcategoryid\", \"productmodelid\", \"sellstartdate\", \"sellenddate\", \"discontinueddate\", \"rowguid\", \"modifieddate\")\nvalues (?::int4, ?::varchar, ?, ?::bool, ?::bool, ?, ?::int2, ?::int2, ?::numeric, ?::numeric, ?, ?::bpchar, ?::bpchar, ?::numeric, ?::int4, ?::bpchar, ?::bpchar, ?::bpchar, ?::int4, ?::int4, ?::timestamp, ?::timestamp, ?::timestamp, ?::uuid, ?::timestamp)\non conflict (\"productid\")\ndo update set\n  \"name\" = EXCLUDED.\"name\",\n\"productnumber\" = EXCLUDED.\"productnumber\",\n\"makeflag\" = EXCLUDED.\"makeflag\",\n\"finishedgoodsflag\" = EXCLUDED.\"finishedgoodsflag\",\n\"color\" = EXCLUDED.\"color\",\n\"safetystocklevel\" = EXCLUDED.\"safetystocklevel\",\n\"reorderpoint\" = EXCLUDED.\"reorderpoint\",\n\"standardcost\" = EXCLUDED.\"standardcost\",\n\"listprice\" = EXCLUDED.\"listprice\",\n\"size\" = EXCLUDED.\"size\",\n\"sizeunitmeasurecode\" = EXCLUDED.\"sizeunitmeasurecode\",\n\"weightunitmeasurecode\" = EXCLUDED.\"weightunitmeasurecode\",\n\"weight\" = EXCLUDED.\"weight\",\n\"daystomanufacture\" = EXCLUDED.\"daystomanufacture\",\n\"productline\" = EXCLUDED.\"productline\",\n\"class\" = EXCLUDED.\"class\",\n\"style\" = EXCLUDED.\"style\",\n\"productsubcategoryid\" = EXCLUDED.\"productsubcategoryid\",\n\"productmodelid\" = EXCLUDED.\"productmodelid\",\n\"sellstartdate\" = EXCLUDED.\"sellstartdate\",\n\"sellenddate\" = EXCLUDED.\"sellenddate\",\n\"discontinueddate\" = EXCLUDED.\"discontinueddate\",\n\"rowguid\" = EXCLUDED.\"rowguid\",\n\"modifieddate\" = EXCLUDED.\"modifieddate\"\nreturning \"productid\", \"name\", \"productnumber\", \"makeflag\", \"finishedgoodsflag\", \"color\", \"safetystocklevel\", \"reorderpoint\", \"standardcost\", \"listprice\", \"size\", \"sizeunitmeasurecode\", \"weightunitmeasurecode\", \"weight\", \"daystomanufacture\", \"productline\", \"class\", \"style\", \"productsubcategoryid\", \"productmodelid\", \"sellstartdate\", \"sellenddate\", \"discontinueddate\", \"rowguid\", \"modifieddate\""))
