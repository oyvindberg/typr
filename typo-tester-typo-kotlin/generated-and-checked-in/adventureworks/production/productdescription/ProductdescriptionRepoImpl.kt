...
class ProductdescriptionRepoImpl() : ProductdescriptionRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"production\".\"productdescription\" where \"productdescriptionid\" = "), Fragment.encode(ProductdescriptionId.pgType, productdescriptionid), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into \"production\".\"productdescription\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"productdescriptionid\", \"description\", \"rowguid\", \"modifieddate\"\n"))
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<ProductdescriptionRow>,
    c: Connection
  ): List<ProductdescriptionRow> = interpolate(Fragment.lit("insert into \"production\".\"productdescription\"(\"productdescriptionid\", \"description\", \"rowguid\", \"modifieddate\")\nvalues (?::int4, ?, ?::uuid, ?::timestamp)\non conflict (\"productdescriptionid\")\ndo update set\n  \"description\" = EXCLUDED.\"description\",\n\"rowguid\" = EXCLUDED.\"rowguid\",\n\"modifieddate\" = EXCLUDED.\"modifieddate\"\nreturning \"productdescriptionid\", \"description\", \"rowguid\", \"modifieddate\""))
