...
class ProductmodelRepoImpl() : ProductmodelRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"production\".\"productmodel\" where \"productmodelid\" = "), Fragment.encode(ProductmodelId.pgType, productmodelid), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(interpolate(Fragment.encode(PgTypes.xml.nullable(), unsaved.catalogdescription), Fragment.lit("::xml")))
    columns.add(Fragment.lit("\"instructions\""))
    values.add(interpolate(Fragment.encode(PgTypes.xml.nullable(), unsaved.instructions), Fragment.lit("::xml")))
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into \"production\".\"productmodel\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\"\n"))
  ...
  override fun selectAll(c: Connection): List<ProductmodelRow> = interpolate(Fragment.lit("select \"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"productmodel\"\n")).query(ProductmodelRow._rowParser.all()).runUnchecked(c)

  override fun selectById(
    productmodelid: ProductmodelId,
    c: Connection
  ): ProductmodelRow? = interpolate(Fragment.lit("select \"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"productmodel\"\nwhere \"productmodelid\" = "), Fragment.encode(ProductmodelId.pgType, productmodelid), Fragment.lit("")).query(ProductmodelRow._rowParser.first()).runUnchecked(c)

  override fun selectByIds(
    productmodelids: Array<ProductmodelId>,
    c: Connection
  ): List<ProductmodelRow> = interpolate(Fragment.lit("select \"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"productmodel\"\nwhere \"productmodelid\" = ANY("), Fragment.encode(ProductmodelId.pgTypeArray, productmodelids), Fragment.lit(")")).query(ProductmodelRow._rowParser.all()).runUnchecked(c)
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<ProductmodelRow>,
    c: Connection
  ): List<ProductmodelRow> = interpolate(Fragment.lit("insert into \"production\".\"productmodel\"(\"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\")\nvalues (?::int4, ?::varchar, ?::xml, ?::xml, ?::uuid, ?::timestamp)\non conflict (\"productmodelid\")\ndo update set\n  \"name\" = EXCLUDED.\"name\",\n\"catalogdescription\" = EXCLUDED.\"catalogdescription\",\n\"instructions\" = EXCLUDED.\"instructions\",\n\"rowguid\" = EXCLUDED.\"rowguid\",\n\"modifieddate\" = EXCLUDED.\"modifieddate\"\nreturning \"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\""))
