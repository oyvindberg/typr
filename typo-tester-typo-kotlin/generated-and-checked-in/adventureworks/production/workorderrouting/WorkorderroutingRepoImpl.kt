...
class WorkorderroutingRepoImpl() : WorkorderroutingRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"production\".\"workorderrouting\" where \"workorderid\" = "), Fragment.encode(WorkorderId.pgType, compositeId.workorderid), Fragment.lit(" AND \"productid\" = "), Fragment.encode(KotlinDbTypes.PgTypes.int4, compositeId.productid), Fragment.lit(" AND \"operationsequence\" = "), Fragment.encode(KotlinDbTypes.PgTypes.int2, compositeId.operationsequence), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int4, unsaved.productid), Fragment.lit("::int4")))
    columns.add(Fragment.lit("\"operationsequence\""))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int2, unsaved.operationsequence), Fragment.lit("::int2")))
    ...
    values.add(interpolate(Fragment.encode(PgTypes.timestamp.nullable(), unsaved.actualstartdate), Fragment.lit("::timestamp")))
    columns.add(Fragment.lit("\"actualenddate\""))
    values.add(interpolate(Fragment.encode(PgTypes.timestamp.nullable(), unsaved.actualenddate), Fragment.lit("::timestamp")))
    columns.add(Fragment.lit("\"actualresourcehrs\""))
    values.add(interpolate(Fragment.encode(PgTypes.numeric.nullable(), unsaved.actualresourcehrs), Fragment.lit("::numeric")))
    ...
    values.add(interpolate(Fragment.encode(PgTypes.numeric.nullable(), unsaved.actualcost), Fragment.lit("::numeric")))
    unsaved.modifieddate.visit(
      {  },
      { value -> columns.add(Fragment.lit("\"modifieddate\""))
      values.add(interpolate(Fragment.encode(PgTypes.timestamp, value), Fragment.lit("::timestamp"))) }
    );
    val q: Fragment = interpolate(Fragment.lit("insert into \"production\".\"workorderrouting\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"workorderid\", \"productid\", \"operationsequence\", \"locationid\", \"scheduledstartdate\", \"scheduledenddate\", \"actualstartdate\", \"actualenddate\", \"actualresourcehrs\", \"plannedcost\", \"actualcost\", \"modifieddate\"\n"))
  ...
  override fun selectAll(c: Connection): List<WorkorderroutingRow> = interpolate(Fragment.lit("select \"workorderid\", \"productid\", \"operationsequence\", \"locationid\", \"scheduledstartdate\", \"scheduledenddate\", \"actualstartdate\", \"actualenddate\", \"actualresourcehrs\", \"plannedcost\", \"actualcost\", \"modifieddate\"\nfrom \"production\".\"workorderrouting\"\n")).query(WorkorderroutingRow._rowParser.all()).runUnchecked(c)

  override fun selectById(
    compositeId: WorkorderroutingId,
    c: Connection
  ): WorkorderroutingRow? = interpolate(Fragment.lit("select \"workorderid\", \"productid\", \"operationsequence\", \"locationid\", \"scheduledstartdate\", \"scheduledenddate\", \"actualstartdate\", \"actualenddate\", \"actualresourcehrs\", \"plannedcost\", \"actualcost\", \"modifieddate\"\nfrom \"production\".\"workorderrouting\"\nwhere \"workorderid\" = "), Fragment.encode(WorkorderId.pgType, compositeId.workorderid), Fragment.lit(" AND \"productid\" = "), Fragment.encode(KotlinDbTypes.PgTypes.int4, compositeId.productid), Fragment.lit(" AND \"operationsequence\" = "), Fragment.encode(KotlinDbTypes.PgTypes.int2, compositeId.operationsequence), Fragment.lit("")).query(WorkorderroutingRow._rowParser.first()).runUnchecked(c)
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<WorkorderroutingRow>,
    c: Connection
  ): List<WorkorderroutingRow> = interpolate(Fragment.lit("insert into \"production\".\"workorderrouting\"(\"workorderid\", \"productid\", \"operationsequence\", \"locationid\", \"scheduledstartdate\", \"scheduledenddate\", \"actualstartdate\", \"actualenddate\", \"actualresourcehrs\", \"plannedcost\", \"actualcost\", \"modifieddate\")\nvalues (?::int4, ?::int4, ?::int2, ?::int2, ?::timestamp, ?::timestamp, ?::timestamp, ?::timestamp, ?::numeric, ?::numeric, ?::numeric, ?::timestamp)\non conflict (\"workorderid\", \"productid\", \"operationsequence\")\ndo update set\n  \"locationid\" = EXCLUDED.\"locationid\",\n\"scheduledstartdate\" = EXCLUDED.\"scheduledstartdate\",\n\"scheduledenddate\" = EXCLUDED.\"scheduledenddate\",\n\"actualstartdate\" = EXCLUDED.\"actualstartdate\",\n\"actualenddate\" = EXCLUDED.\"actualenddate\",\n\"actualresourcehrs\" = EXCLUDED.\"actualresourcehrs\",\n\"plannedcost\" = EXCLUDED.\"plannedcost\",\n\"actualcost\" = EXCLUDED.\"actualcost\",\n\"modifieddate\" = EXCLUDED.\"modifieddate\"\nreturning \"workorderid\", \"productid\", \"operationsequence\", \"locationid\", \"scheduledstartdate\", \"scheduledenddate\", \"actualstartdate\", \"actualenddate\", \"actualresourcehrs\", \"plannedcost\", \"actualcost\", \"modifieddate\""))
