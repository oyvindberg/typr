...
class PhonenumbertypeRepoImpl() : PhonenumbertypeRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"person\".\"phonenumbertype\" where \"phonenumbertypeid\" = "), Fragment.encode(PhonenumbertypeId.pgType, phonenumbertypeid), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into \"person\".\"phonenumbertype\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"phonenumbertypeid\", \"name\", \"modifieddate\"\n"))
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<PhonenumbertypeRow>,
    c: Connection
  ): List<PhonenumbertypeRow> = interpolate(Fragment.lit("insert into \"person\".\"phonenumbertype\"(\"phonenumbertypeid\", \"name\", \"modifieddate\")\nvalues (?::int4, ?::varchar, ?::timestamp)\non conflict (\"phonenumbertypeid\")\ndo update set\n  \"name\" = EXCLUDED.\"name\",\n\"modifieddate\" = EXCLUDED.\"modifieddate\"\nreturning \"phonenumbertypeid\", \"name\", \"modifieddate\""))
