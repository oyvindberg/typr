...
class CreditcardRepoImpl() : CreditcardRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"sales\".\"creditcard\" where \"creditcardid\" = "), Fragment.encode(CustomCreditcardId.pgType, creditcardid), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int2, unsaved.expmonth), Fragment.lit("::int2")))
    columns.add(Fragment.lit("\"expyear\""))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.PgTypes.int2, unsaved.expyear), Fragment.lit("::int2")))
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into \"sales\".\"creditcard\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"creditcardid\", \"cardtype\", \"cardnumber\", \"expmonth\", \"expyear\", \"modifieddate\"\n"))
  ...
  override fun selectAll(c: Connection): List<CreditcardRow> = interpolate(Fragment.lit("select \"creditcardid\", \"cardtype\", \"cardnumber\", \"expmonth\", \"expyear\", \"modifieddate\"\nfrom \"sales\".\"creditcard\"\n")).query(CreditcardRow._rowParser.all()).runUnchecked(c)

  override fun selectById(
    creditcardid: /* user-picked */ CustomCreditcardId,
    c: Connection
  ): CreditcardRow? = interpolate(Fragment.lit("select \"creditcardid\", \"cardtype\", \"cardnumber\", \"expmonth\", \"expyear\", \"modifieddate\"\nfrom \"sales\".\"creditcard\"\nwhere \"creditcardid\" = "), Fragment.encode(CustomCreditcardId.pgType, creditcardid), Fragment.lit("")).query(CreditcardRow._rowParser.first()).runUnchecked(c)

  override fun selectByIds(
    creditcardids: Array</* user-picked */ CustomCreditcardId>,
    c: Connection
  ): List<CreditcardRow> = interpolate(Fragment.lit("select \"creditcardid\", \"cardtype\", \"cardnumber\", \"expmonth\", \"expyear\", \"modifieddate\"\nfrom \"sales\".\"creditcard\"\nwhere \"creditcardid\" = ANY("), Fragment.encode(CustomCreditcardId.pgTypeArray, creditcardids), Fragment.lit(")")).query(CreditcardRow._rowParser.all()).runUnchecked(c)
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<CreditcardRow>,
    c: Connection
  ): List<CreditcardRow> = interpolate(Fragment.lit("insert into \"sales\".\"creditcard\"(\"creditcardid\", \"cardtype\", \"cardnumber\", \"expmonth\", \"expyear\", \"modifieddate\")\nvalues (?::int4, ?, ?, ?::int2, ?::int2, ?::timestamp)\non conflict (\"creditcardid\")\ndo update set\n  \"cardtype\" = EXCLUDED.\"cardtype\",\n\"cardnumber\" = EXCLUDED.\"cardnumber\",\n\"expmonth\" = EXCLUDED.\"expmonth\",\n\"expyear\" = EXCLUDED.\"expyear\",\n\"modifieddate\" = EXCLUDED.\"modifieddate\"\nreturning \"creditcardid\", \"cardtype\", \"cardnumber\", \"expmonth\", \"expyear\", \"modifieddate\""))
