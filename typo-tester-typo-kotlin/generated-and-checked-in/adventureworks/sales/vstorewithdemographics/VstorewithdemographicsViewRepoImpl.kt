...
class VstorewithdemographicsViewRepoImpl() : VstorewithdemographicsViewRepo {
  ...
  override fun selectAll(c: Connection): List<VstorewithdemographicsViewRow> = interpolate(Fragment.lit("select \"businessentityid\", \"name\", \"AnnualSales\"::numeric, \"AnnualRevenue\"::numeric, \"BankName\", \"BusinessType\", \"YearOpened\", \"Specialty\", \"SquareFeet\", \"Brands\", \"Internet\", \"NumberEmployees\"\nfrom \"sales\".\"vstorewithdemographics\"\n")).query(VstorewithdemographicsViewRow._rowParser.all()).runUnchecked(c)
}