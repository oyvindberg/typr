...
class TableWithGeneratedColumnsRepoImpl() : TableWithGeneratedColumnsRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from \"public\".\"table-with-generated-columns\" where \"name\" = "), Fragment.encode(TableWithGeneratedColumnsId.pgType, name), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into \"public\".\"table-with-generated-columns\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"name\", \"name-type-always\"\n"))
  ...
  override fun upsertBatch(
    unsaved: MutableIterator<TableWithGeneratedColumnsRow>,
    c: Connection
  ): List<TableWithGeneratedColumnsRow> = interpolate(Fragment.lit("insert into \"public\".\"table-with-generated-columns\"(\"name\")\nvalues (?)\non conflict (\"name\")\ndo update set \"name\" = EXCLUDED.\"name\"\nreturning \"name\", \"name-type-always\""))
