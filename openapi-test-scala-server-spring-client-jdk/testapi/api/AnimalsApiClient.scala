...
class AnimalsApiClient(
  ...
  override def listAnimals: Response2004XX5XX[List[Animal]] = {
    ...
    if (statusCode == 200) return new testapi.api.Ok(objectMapper.readValue(response.body(), new com.fasterxml.jackson.core.`type`.TypeReference[scala.List[testapi.model.Animal]] {}))
