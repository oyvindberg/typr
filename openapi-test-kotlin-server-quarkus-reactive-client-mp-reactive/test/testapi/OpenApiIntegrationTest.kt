...
/**
 * Unit tests for the OpenAPI generated Kotlin Quarkus Reactive server code.
 *
...
class OpenApiIntegrationTest {
    ...
    inner class TestPetsApiServer : PetsApiServer {
        ...
        override fun listPets(limit: Optional<Integer>, status: Optional<String>): Uni<List<Pet>> {
    ...
    fun testCreatePetReturnsCreated() {
        ...
        val result = server.createPet(newPet).await().indefinitely()
    ...
    fun testListPetsReturnsList() {
        val server = TestPetsApiServer()
        val result = server.listPets(Optional.empty(), Optional.empty()).await().indefinitely()
