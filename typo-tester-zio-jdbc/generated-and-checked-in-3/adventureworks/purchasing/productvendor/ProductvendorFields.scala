...
trait ProductvendorFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductvendorId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductvendorId](productid)(_.productid)(using as[Array[ProductId], Required](using ProductId.arrayJdbcEncoder, PGType.forArray(using ProductId.pgType)), implicitly), TuplePart[ProductvendorId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId], Required](using BusinessentityId.arrayJdbcEncoder, PGType.forArray(using BusinessentityId.pgType)), implicitly))
