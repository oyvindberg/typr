...
trait PurchaseorderdetailFields {
  ...
  def compositeIdIn(compositeIds: Array[PurchaseorderdetailId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[PurchaseorderdetailId](purchaseorderid)(_.purchaseorderid)(using as[Array[PurchaseorderheaderId], Required](using PurchaseorderheaderId.arrayJdbcEncoder, PGType.forArray(using PurchaseorderheaderId.pgType)), implicitly), TuplePart[PurchaseorderdetailId](purchaseorderdetailid)(_.purchaseorderdetailid)(using as[Array[Int], Required](using adventureworks.IntArrayEncoder, PGType.forArray(using PGType.PGTypeInt)), implicitly))
