...
trait EmployeedepartmenthistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[EmployeedepartmenthistoryId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[EmployeedepartmenthistoryId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId], Required](using BusinessentityId.arrayJdbcEncoder, PGType.forArray(using BusinessentityId.pgType)), implicitly), TuplePart[EmployeedepartmenthistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDate], Required](using TypoLocalDate.arrayJdbcEncoder, PGType.forArray(using TypoLocalDate.pgType)), implicitly), TuplePart[EmployeedepartmenthistoryId](departmentid)(_.departmentid)(using as[Array[DepartmentId], Required](using DepartmentId.arrayJdbcEncoder, PGType.forArray(using DepartmentId.pgType)), implicitly), TuplePart[EmployeedepartmenthistoryId](shiftid)(_.shiftid)(using as[Array[ShiftId], Required](using ShiftId.arrayJdbcEncoder, PGType.forArray(using ShiftId.pgType)), implicitly))
