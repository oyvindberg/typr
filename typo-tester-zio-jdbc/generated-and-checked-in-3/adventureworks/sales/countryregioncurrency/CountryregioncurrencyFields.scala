...
trait CountryregioncurrencyFields {
  ...
  def compositeIdIn(compositeIds: Array[CountryregioncurrencyId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[CountryregioncurrencyId](countryregioncode)(_.countryregioncode)(using as[Array[CountryregionId], Required](using CountryregionId.arrayJdbcEncoder, PGType.forArray(using CountryregionId.pgType)), implicitly), TuplePart[CountryregioncurrencyId](currencycode)(_.currencycode)(using as[Array[CurrencyId], Required](using CurrencyId.arrayJdbcEncoder, PGType.forArray(using CurrencyId.pgType)), implicitly))
