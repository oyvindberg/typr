...
class TestUtdanningstilbudRepoImpl extends TestUtdanningstilbudRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, TestUtdanningstilbudRow] = sql"""select "organisasjonskode", "utdanningsmulighet_kode" from "public"."test_utdanningstilbud"""".query(using TestUtdanningstilbudRow.jdbcDecoder).selectStream()

  def selectById(compositeId: TestUtdanningstilbudId): ZIO[ZConnection, Throwable, Option[TestUtdanningstilbudRow]] = sql"""select "organisasjonskode", "utdanningsmulighet_kode" from "public"."test_utdanningstilbud" where "organisasjonskode" = ${Segment.paramSegment(compositeId.organisasjonskode)(using TestOrganisasjonId.setter)} AND "utdanningsmulighet_kode" = ${Segment.paramSegment(compositeId.utdanningsmulighetKode)(using Setter.stringSetter)}""".query(using TestUtdanningstilbudRow.jdbcDecoder).selectOne
