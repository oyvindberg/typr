...
trait BusinessentityaddressFields {
  ...
  def compositeIdIn(compositeIds: Array[BusinessentityaddressId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[BusinessentityaddressId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId], Required](using BusinessentityId.arrayJdbcEncoder, PGType.forArray(using BusinessentityId.pgType)), implicitly), TuplePart[BusinessentityaddressId](addressid)(_.addressid)(using as[Array[AddressId], Required](using AddressId.arrayJdbcEncoder, PGType.forArray(using AddressId.pgType)), implicitly), TuplePart[BusinessentityaddressId](addresstypeid)(_.addresstypeid)(using as[Array[AddresstypeId], Required](using AddresstypeId.arrayJdbcEncoder, PGType.forArray(using AddresstypeId.pgType)), implicitly))
