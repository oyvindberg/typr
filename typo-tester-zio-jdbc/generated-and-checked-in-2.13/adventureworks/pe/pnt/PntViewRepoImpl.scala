...
class PntViewRepoImpl extends PntViewRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, PntViewRow] = sql"""select "id", "phonenumbertypeid", "name", "modifieddate"::text from "pe"."pnt"""".query(PntViewRow.jdbcDecoder).selectStream()
}