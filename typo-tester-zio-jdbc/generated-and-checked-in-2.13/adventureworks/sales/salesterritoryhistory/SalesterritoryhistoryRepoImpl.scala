...
class SalesterritoryhistoryRepoImpl extends SalesterritoryhistoryRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, SalesterritoryhistoryRow] = sql"""select "businessentityid", "territoryid", "startdate"::text, "enddate"::text, "rowguid", "modifieddate"::text from "sales"."salesterritoryhistory"""".query(SalesterritoryhistoryRow.jdbcDecoder).selectStream()
