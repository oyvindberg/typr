...
class VstorewithaddressesViewRepoImpl extends VstorewithaddressesViewRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, VstorewithaddressesViewRow] = sql"""select "businessentityid", "name", "addresstype", "addressline1", "addressline2", "city", "stateprovincename", "postalcode", "countryregionname" from "sales"."vstorewithaddresses"""".query(VstorewithaddressesViewRow.jdbcDecoder).selectStream()
}