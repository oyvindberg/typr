...
class CustomerRepoImpl extends CustomerRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, CustomerRow] = sql"""select "customerid", "personid", "storeid", "territoryid", "rowguid", "modifieddate"::text from "sales"."customer"""".query(CustomerRow.jdbcDecoder).selectStream()

  def selectById(customerid: CustomerId): ZIO[ZConnection, Throwable, Option[CustomerRow]] = sql"""select "customerid", "personid", "storeid", "territoryid", "rowguid", "modifieddate"::text from "sales"."customer" where "customerid" = ${Segment.paramSegment(customerid)(CustomerId.setter)}""".query(CustomerRow.jdbcDecoder).selectOne
