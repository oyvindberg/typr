...
class StoreRepoImpl extends StoreRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, StoreRow] = sql"""select "businessentityid", "name", "salespersonid", "demographics", "rowguid", "modifieddate"::text from "sales"."store"""".query(StoreRow.jdbcDecoder).selectStream()
