...
class SalesreasonRepoImpl extends SalesreasonRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, SalesreasonRow] = sql"""select "salesreasonid", "name", "reasontype", "modifieddate"::text from "sales"."salesreason"""".query(SalesreasonRow.jdbcDecoder).selectStream()

  def selectById(salesreasonid: SalesreasonId): ZIO[ZConnection, Throwable, Option[SalesreasonRow]] = sql"""select "salesreasonid", "name", "reasontype", "modifieddate"::text from "sales"."salesreason" where "salesreasonid" = ${Segment.paramSegment(salesreasonid)(SalesreasonId.setter)}""".query(SalesreasonRow.jdbcDecoder).selectOne
