...
class ShoppingcartitemRepoImpl extends ShoppingcartitemRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, ShoppingcartitemRow] = sql"""select "shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated"::text, "modifieddate"::text from "sales"."shoppingcartitem"""".query(ShoppingcartitemRow.jdbcDecoder).selectStream()
