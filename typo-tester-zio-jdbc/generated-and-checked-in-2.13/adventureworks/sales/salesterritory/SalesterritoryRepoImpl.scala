...
class SalesterritoryRepoImpl extends SalesterritoryRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, SalesterritoryRow] = sql"""select "territoryid", "name", "countryregioncode", "group", "salesytd", "saleslastyear", "costytd", "costlastyear", "rowguid", "modifieddate"::text from "sales"."salesterritory"""".query(SalesterritoryRow.jdbcDecoder).selectStream()
