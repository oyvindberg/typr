...
class FlaffRepoImpl extends FlaffRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, FlaffRow] = sql"""select "code", "another_code", "some_number", "specifier", "parentspecifier" from "public"."flaff"""".query(FlaffRow.jdbcDecoder).selectStream()
