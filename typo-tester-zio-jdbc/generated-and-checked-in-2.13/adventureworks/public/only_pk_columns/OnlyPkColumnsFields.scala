...
trait OnlyPkColumnsFields {
  ...
  def compositeIdIn(compositeIds: Array[OnlyPkColumnsId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[OnlyPkColumnsId](keyColumn1)(_.keyColumn1)(using as[Array[String], Required](adventureworks.StringArrayEncoder, PGType.forArray(PGType.PGTypeString)), implicitly), TuplePart[OnlyPkColumnsId](keyColumn2)(_.keyColumn2)(using as[Array[Int], Required](adventureworks.IntArrayEncoder, PGType.forArray(PGType.PGTypeInt)), implicitly))
