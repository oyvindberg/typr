...
class EmployeepayhistoryRepoImpl extends EmployeepayhistoryRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, EmployeepayhistoryRow] = sql"""select "businessentityid", "ratechangedate"::text, "rate", "payfrequency", "modifieddate"::text from "humanresources"."employeepayhistory"""".query(EmployeepayhistoryRow.jdbcDecoder).selectStream()
