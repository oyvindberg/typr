...
class JobcandidateRepoImpl extends JobcandidateRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, JobcandidateRow] = sql"""select "jobcandidateid", "businessentityid", "resume", "modifieddate"::text from "humanresources"."jobcandidate"""".query(JobcandidateRow.jdbcDecoder).selectStream()
