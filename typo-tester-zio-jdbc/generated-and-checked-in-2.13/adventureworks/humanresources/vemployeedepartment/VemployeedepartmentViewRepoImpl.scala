...
class VemployeedepartmentViewRepoImpl extends VemployeedepartmentViewRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, VemployeedepartmentViewRow] = sql"""select "businessentityid", "title", "firstname", "middlename", "lastname", "suffix", "jobtitle", "department", "groupname", "startdate"::text from "humanresources"."vemployeedepartment"""".query(VemployeedepartmentViewRow.jdbcDecoder).selectStream()
}