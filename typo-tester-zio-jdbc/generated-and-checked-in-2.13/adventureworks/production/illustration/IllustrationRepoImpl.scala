...
class IllustrationRepoImpl extends IllustrationRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, IllustrationRow] = sql"""select "illustrationid", "diagram", "modifieddate"::text from "production"."illustration"""".query(IllustrationRow.jdbcDecoder).selectStream()

  def selectById(illustrationid: IllustrationId): ZIO[ZConnection, Throwable, Option[IllustrationRow]] = sql"""select "illustrationid", "diagram", "modifieddate"::text from "production"."illustration" where "illustrationid" = ${Segment.paramSegment(illustrationid)(IllustrationId.setter)}""".query(IllustrationRow.jdbcDecoder).selectOne
