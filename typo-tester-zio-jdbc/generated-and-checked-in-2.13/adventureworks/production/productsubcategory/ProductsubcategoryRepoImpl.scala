...
class ProductsubcategoryRepoImpl extends ProductsubcategoryRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, ProductsubcategoryRow] = sql"""select "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text from "production"."productsubcategory"""".query(ProductsubcategoryRow.jdbcDecoder).selectStream()
