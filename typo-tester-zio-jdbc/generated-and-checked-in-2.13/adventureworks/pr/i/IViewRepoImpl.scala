...
class IViewRepoImpl extends IViewRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, IViewRow] = sql"""select "id", "illustrationid", "diagram", "modifieddate"::text from "pr"."i"""".query(IViewRow.jdbcDecoder).selectStream()
}