...
class PersonRepoImpl extends PersonRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, PersonRow] = sql"""select "businessentityid", "persontype", "namestyle", "title", "firstname", "middlename", "lastname", "suffix", "emailpromotion", "additionalcontactinfo", "demographics", "rowguid", "modifieddate"::text from "person"."person"""".query(PersonRow.jdbcDecoder).selectStream()
