...
class ContacttypeRepoImpl extends ContacttypeRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, ContacttypeRow] = sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype"""".query(ContacttypeRow.jdbcDecoder).selectStream()

  def selectById(contacttypeid: ContacttypeId): ZIO[ZConnection, Throwable, Option[ContacttypeRow]] = sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype" where "contacttypeid" = ${Segment.paramSegment(contacttypeid)(ContacttypeId.setter)}""".query(ContacttypeRow.jdbcDecoder).selectOne

  def selectByIds(contacttypeids: Array[ContacttypeId]): ZStream[ZConnection, Throwable, ContacttypeRow] = sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype" where "contacttypeid" = ANY(${Segment.paramSegment(contacttypeids)(ContacttypeId.arraySetter)})""".query(ContacttypeRow.jdbcDecoder).selectStream()
