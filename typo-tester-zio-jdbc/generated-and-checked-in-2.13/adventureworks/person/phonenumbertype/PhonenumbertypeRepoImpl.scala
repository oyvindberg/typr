...
class PhonenumbertypeRepoImpl extends PhonenumbertypeRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, PhonenumbertypeRow] = sql"""select "phonenumbertypeid", "name", "modifieddate"::text from "person"."phonenumbertype"""".query(PhonenumbertypeRow.jdbcDecoder).selectStream()
