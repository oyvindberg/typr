...
class BusinessentitycontactRepoImpl extends BusinessentitycontactRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, BusinessentitycontactRow] = sql"""select "businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate"::text from "person"."businessentitycontact"""".query(BusinessentitycontactRow.jdbcDecoder).selectStream()
