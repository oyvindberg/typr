...
class JobcandidateRepoImpl extends JobcandidateRepo {
  ...
  override def deleteByIds(jobcandidateids: Array[JobcandidateId]): ConnectionIO[Int] = {
    sql"""delete from "humanresources"."jobcandidate" where "jobcandidateid" = ANY(${fromWrite(jobcandidateids)(new Write.Single(JobcandidateId.arrayPut))})""".update.run
  }
  ...
  override def selectByIds(jobcandidateids: Array[JobcandidateId]): Stream[ConnectionIO, JobcandidateRow] = {
    sql"""select "jobcandidateid", "businessentityid", "resume", "modifieddate"::text from "humanresources"."jobcandidate" where "jobcandidateid" = ANY(${fromWrite(jobcandidateids)(new Write.Single(JobcandidateId.arrayPut))})""".query(JobcandidateRow.read).stream
  }
