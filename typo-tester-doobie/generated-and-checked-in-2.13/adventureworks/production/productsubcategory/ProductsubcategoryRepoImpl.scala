...
class ProductsubcategoryRepoImpl extends ProductsubcategoryRepo {
  def delete: DeleteBuilder[ProductsubcategoryFields, ProductsubcategoryRow] = DeleteBuilder.of(""""production"."productsubcategory"""", ProductsubcategoryFields.structure, ProductsubcategoryRow.read)

  def deleteById(productsubcategoryid: ProductsubcategoryId): ConnectionIO[Boolean] = sql"""delete from "production"."productsubcategory" where "productsubcategoryid" = ${fromWrite(productsubcategoryid)(new Write.Single(ProductsubcategoryId.put))}""".update.run.map(_ > 0)

  def deleteByIds(productsubcategoryids: Array[ProductsubcategoryId]): ConnectionIO[Int] = sql"""delete from "production"."productsubcategory" where "productsubcategoryid" = ANY(${fromWrite(productsubcategoryids)(new Write.Single(ProductsubcategoryId.arrayPut))})""".update.run
  ...
  def select: SelectBuilder[ProductsubcategoryFields, ProductsubcategoryRow] = SelectBuilder.of(""""production"."productsubcategory"""", ProductsubcategoryFields.structure, ProductsubcategoryRow.read)

  def selectAll: Stream[ConnectionIO, ProductsubcategoryRow] = sql"""select "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text from "production"."productsubcategory"""".query(ProductsubcategoryRow.read).stream
  ...
  def update: UpdateBuilder[ProductsubcategoryFields, ProductsubcategoryRow] = UpdateBuilder.of(""""production"."productsubcategory"""", ProductsubcategoryFields.structure, ProductsubcategoryRow.read)
