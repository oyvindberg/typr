...
class ProductsubcategoryRepoImpl extends ProductsubcategoryRepo {
  ...
  override def deleteByIds(productsubcategoryids: Array[ProductsubcategoryId]): ConnectionIO[Int] = {
    sql"""delete from "production"."productsubcategory" where "productsubcategoryid" = ANY(${fromWrite(productsubcategoryids)(new Write.Single(ProductsubcategoryId.arrayPut))})""".update.run
  }
  ...
  override def selectByIds(productsubcategoryids: Array[ProductsubcategoryId]): Stream[ConnectionIO, ProductsubcategoryRow] = {
    sql"""select "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text from "production"."productsubcategory" where "productsubcategoryid" = ANY(${fromWrite(productsubcategoryids)(new Write.Single(ProductsubcategoryId.arrayPut))})""".query(ProductsubcategoryRow.read).stream
  }
