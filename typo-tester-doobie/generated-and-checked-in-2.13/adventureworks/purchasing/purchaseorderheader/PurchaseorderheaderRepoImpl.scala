...
class PurchaseorderheaderRepoImpl extends PurchaseorderheaderRepo {
  ...
  override def deleteByIds(purchaseorderids: Array[PurchaseorderheaderId]): ConnectionIO[Int] = {
    sql"""delete from "purchasing"."purchaseorderheader" where "purchaseorderid" = ANY(${fromWrite(purchaseorderids)(new Write.Single(PurchaseorderheaderId.arrayPut))})""".update.run
  }
