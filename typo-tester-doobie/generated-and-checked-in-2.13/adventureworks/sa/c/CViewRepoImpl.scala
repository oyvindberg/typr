...
class CViewRepoImpl extends CViewRepo {
  ...
  def selectAll: Stream[ConnectionIO, CViewRow] = sql"""select "id", "customerid", "personid", "storeid", "territoryid", "rowguid", "modifieddate"::text from "sa"."c"""".query(CViewRow.read).stream
}