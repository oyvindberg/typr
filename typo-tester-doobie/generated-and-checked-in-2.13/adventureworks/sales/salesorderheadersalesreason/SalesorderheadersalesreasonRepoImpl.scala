...
class SalesorderheadersalesreasonRepoImpl extends SalesorderheadersalesreasonRepo {
  ...
  def selectAll: Stream[ConnectionIO, SalesorderheadersalesreasonRow] = sql"""select "salesorderid", "salesreasonid", "modifieddate"::text from "sales"."salesorderheadersalesreason"""".query(SalesorderheadersalesreasonRow.read).stream
