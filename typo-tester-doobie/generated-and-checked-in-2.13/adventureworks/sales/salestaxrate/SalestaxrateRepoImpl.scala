...
class SalestaxrateRepoImpl extends SalestaxrateRepo {
  ...
  override def deleteByIds(salestaxrateids: Array[SalestaxrateId]): ConnectionIO[Int] = {
    sql"""delete from "sales"."salestaxrate" where "salestaxrateid" = ANY(${fromWrite(salestaxrateids)(new Write.Single(SalestaxrateId.arrayPut))})""".update.run
  }
  ...
  override def selectByIds(salestaxrateids: Array[SalestaxrateId]): Stream[ConnectionIO, SalestaxrateRow] = {
    sql"""select "salestaxrateid", "stateprovinceid", "taxtype", "taxrate", "name", "rowguid", "modifieddate"::text from "sales"."salestaxrate" where "salestaxrateid" = ANY(${fromWrite(salestaxrateids)(new Write.Single(SalestaxrateId.arrayPut))})""".query(SalestaxrateRow.read).stream
  }
