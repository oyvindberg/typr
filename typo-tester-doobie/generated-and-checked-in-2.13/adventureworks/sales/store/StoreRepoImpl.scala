...
class StoreRepoImpl extends StoreRepo {
  def delete: DeleteBuilder[StoreFields, StoreRow] = DeleteBuilder.of(""""sales"."store"""", StoreFields.structure, StoreRow.read)

  def deleteById(businessentityid: BusinessentityId): ConnectionIO[Boolean] = sql"""delete from "sales"."store" where "businessentityid" = ${fromWrite(businessentityid)(new Write.Single(BusinessentityId.put))}""".update.run.map(_ > 0)

  def deleteByIds(businessentityids: Array[BusinessentityId]): ConnectionIO[Int] = sql"""delete from "sales"."store" where "businessentityid" = ANY(${fromWrite(businessentityids)(new Write.Single(BusinessentityId.arrayPut))})""".update.run
  ...
  def select: SelectBuilder[StoreFields, StoreRow] = SelectBuilder.of(""""sales"."store"""", StoreFields.structure, StoreRow.read)

  def selectAll: Stream[ConnectionIO, StoreRow] = sql"""select "businessentityid", "name", "salespersonid", "demographics", "rowguid", "modifieddate"::text from "sales"."store"""".query(StoreRow.read).stream

  def selectById(businessentityid: BusinessentityId): ConnectionIO[Option[StoreRow]] = sql"""select "businessentityid", "name", "salespersonid", "demographics", "rowguid", "modifieddate"::text from "sales"."store" where "businessentityid" = ${fromWrite(businessentityid)(new Write.Single(BusinessentityId.put))}""".query(StoreRow.read).option
  ...
  def update: UpdateBuilder[StoreFields, StoreRow] = UpdateBuilder.of(""""sales"."store"""", StoreFields.structure, StoreRow.read)
