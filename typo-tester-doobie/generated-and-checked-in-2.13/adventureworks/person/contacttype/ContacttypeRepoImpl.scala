...
class ContacttypeRepoImpl extends ContacttypeRepo {
  ...
  def deleteById(contacttypeid: ContacttypeId): ConnectionIO[Boolean] = sql"""delete from "person"."contacttype" where "contacttypeid" = ${fromWrite(contacttypeid)(new Write.Single(ContacttypeId.put))}""".update.run.map(_ > 0)

  def deleteByIds(contacttypeids: Array[ContacttypeId]): ConnectionIO[Int] = sql"""delete from "person"."contacttype" where "contacttypeid" = ANY(${fromWrite(contacttypeids)(new Write.Single(ContacttypeId.arrayPut))})""".update.run
  ...
  def selectAll: Stream[ConnectionIO, ContacttypeRow] = sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype"""".query(ContacttypeRow.read).stream

  def selectById(contacttypeid: ContacttypeId): ConnectionIO[Option[ContacttypeRow]] = sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype" where "contacttypeid" = ${fromWrite(contacttypeid)(new Write.Single(ContacttypeId.put))}""".query(ContacttypeRow.read).option

  def selectByIds(contacttypeids: Array[ContacttypeId]): Stream[ConnectionIO, ContacttypeRow] = sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype" where "contacttypeid" = ANY(${fromWrite(contacttypeids)(new Write.Single(ContacttypeId.arrayPut))})""".query(ContacttypeRow.read).stream
