...
class EmailaddressRepoImpl extends EmailaddressRepo {
  ...
  def selectAll: Stream[ConnectionIO, EmailaddressRow] = sql"""select "businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate"::text from "person"."emailaddress"""".query(EmailaddressRow.read).stream
