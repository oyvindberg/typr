...
class PgtestRepoImpl extends PgtestRepo {
  ...
  def select: SelectBuilder[PgtestFields, PgtestRow] = SelectBuilder.of(""""public"."pgtest"""", PgtestFields.structure, PgtestRow.read)
  ...
  def update: UpdateBuilder[PgtestFields, PgtestRow] = UpdateBuilder.of(""""public"."pgtest"""", PgtestFields.structure, PgtestRow.read)
}