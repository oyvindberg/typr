...
trait OnlyPkColumnsFields {
  ...
  def compositeIdIn(compositeIds: Array[OnlyPkColumnsId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[OnlyPkColumnsId](keyColumn1)(_.keyColumn1)(using as[Array[String], Required](adventureworks.StringArrayMeta.put, Write.fromPut(adventureworks.StringArrayMeta.put)), implicitly), TuplePart[OnlyPkColumnsId](keyColumn2)(_.keyColumn2)(using as[Array[Int], Required](adventureworks.IntegerArrayMeta.put, Write.fromPut(adventureworks.IntegerArrayMeta.put)), implicitly))
