...
trait TestSakSoknadsalternativFields {
  ...
  def compositeIdIn(compositeIds: Array[TestSakSoknadsalternativId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[TestSakSoknadsalternativId](organisasjonskodeSaksbehandler)(_.organisasjonskodeSaksbehandler)(using as[Array[String], Required](adventureworks.StringArrayMeta.put, Write.fromPut(adventureworks.StringArrayMeta.put)), implicitly), TuplePart[TestSakSoknadsalternativId](utdanningsmulighetKode)(_.utdanningsmulighetKode)(using as[Array[String], Required](adventureworks.StringArrayMeta.put, Write.fromPut(adventureworks.StringArrayMeta.put)), implicitly))
