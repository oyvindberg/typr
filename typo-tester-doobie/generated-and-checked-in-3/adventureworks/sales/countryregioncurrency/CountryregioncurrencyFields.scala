...
trait CountryregioncurrencyFields {
  ...
  def compositeIdIn(compositeIds: Array[CountryregioncurrencyId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[CountryregioncurrencyId](countryregioncode)(_.countryregioncode)(using as[Array[CountryregionId], Required](using CountryregionId.arrayPut, Write.fromPut(using CountryregionId.arrayPut)), implicitly), TuplePart[CountryregioncurrencyId](currencycode)(_.currencycode)(using as[Array[CurrencyId], Required](using CurrencyId.arrayPut, Write.fromPut(using CurrencyId.arrayPut)), implicitly))
