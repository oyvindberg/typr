...
trait PersoncreditcardFields {
  ...
  def compositeIdIn(compositeIds: Array[PersoncreditcardId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[PersoncreditcardId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId], Required](using BusinessentityId.arrayPut, Write.fromPut(using BusinessentityId.arrayPut)), implicitly), TuplePart[PersoncreditcardId](creditcardid)(_.creditcardid)(using as[Array[/* user-picked */ CustomCreditcardId], Required](using CustomCreditcardId.arrayPut, Write.fromPut(using CustomCreditcardId.arrayPut)), implicitly))
