...
class OnlyPkColumnsRepoImpl extends OnlyPkColumnsRepo {
  ...
  def selectAll: Stream[ConnectionIO, OnlyPkColumnsRow] = sql"""select "key_column_1", "key_column_2" from "public"."only_pk_columns"""".query(using OnlyPkColumnsRow.read).stream
