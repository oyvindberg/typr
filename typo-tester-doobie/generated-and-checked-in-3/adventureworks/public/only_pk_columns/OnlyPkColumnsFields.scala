...
trait OnlyPkColumnsFields {
  ...
  def compositeIdIn(compositeIds: Array[OnlyPkColumnsId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[OnlyPkColumnsId](keyColumn1)(_.keyColumn1)(using as[Array[String], Required](using adventureworks.StringArrayMeta.put, Write.fromPut(using adventureworks.StringArrayMeta.put)), implicitly), TuplePart[OnlyPkColumnsId](keyColumn2)(_.keyColumn2)(using as[Array[Int], Required](using adventureworks.IntegerArrayMeta.put, Write.fromPut(using adventureworks.IntegerArrayMeta.put)), implicitly))
