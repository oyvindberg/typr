...
class Issue1422RepoImpl extends Issue1422Repo {
  ...
  override def deleteByIds(tabellkodes: Array[Issue142Id]): ConnectionIO[Int] = {
    sql"""delete from "public"."issue142_2" where "tabellkode" = ANY(${fromWrite(tabellkodes)(using new Write.Single(Issue142Id.arrayPut))})""".update.run
  }
  ...
  override def selectByIds(tabellkodes: Array[Issue142Id]): Stream[ConnectionIO, Issue1422Row] = {
    sql"""select "tabellkode" from "public"."issue142_2" where "tabellkode" = ANY(${fromWrite(tabellkodes)(using new Write.Single(Issue142Id.arrayPut))})""".query(using Issue1422Row.read).stream
  }
