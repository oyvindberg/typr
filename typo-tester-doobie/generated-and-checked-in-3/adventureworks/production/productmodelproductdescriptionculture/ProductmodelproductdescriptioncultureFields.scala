...
trait ProductmodelproductdescriptioncultureFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelproductdescriptioncultureId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelproductdescriptioncultureId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId], Required](using ProductmodelId.arrayPut, Write.fromPut(using ProductmodelId.arrayPut)), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](productdescriptionid)(_.productdescriptionid)(using as[Array[ProductdescriptionId], Required](using ProductdescriptionId.arrayPut, Write.fromPut(using ProductdescriptionId.arrayPut)), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](cultureid)(_.cultureid)(using as[Array[CultureId], Required](using CultureId.arrayPut, Write.fromPut(using CultureId.arrayPut)), implicitly))
