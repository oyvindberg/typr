...
trait ProductmodelillustrationFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelillustrationId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelillustrationId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId], Required](using ProductmodelId.arrayPut, Write.fromPut(using ProductmodelId.arrayPut)), implicitly), TuplePart[ProductmodelillustrationId](illustrationid)(_.illustrationid)(using as[Array[IllustrationId], Required](using IllustrationId.arrayPut, Write.fromPut(using IllustrationId.arrayPut)), implicitly))
