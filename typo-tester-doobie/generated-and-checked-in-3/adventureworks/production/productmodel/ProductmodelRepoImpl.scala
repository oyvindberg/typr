...
class ProductmodelRepoImpl extends ProductmodelRepo {
  ...
  override def deleteByIds(productmodelids: Array[ProductmodelId]): ConnectionIO[Int] = {
    sql"""delete from "production"."productmodel" where "productmodelid" = ANY(${fromWrite(productmodelids)(using new Write.Single(ProductmodelId.arrayPut))})""".update.run
  }
  ...
  override def selectByIds(productmodelids: Array[ProductmodelId]): Stream[ConnectionIO, ProductmodelRow] = {
    sql"""select "productmodelid", "name", "catalogdescription", "instructions", "rowguid", "modifieddate"::text from "production"."productmodel" where "productmodelid" = ANY(${fromWrite(productmodelids)(using new Write.Single(ProductmodelId.arrayPut))})""".query(using ProductmodelRow.read).stream
  }
