...
class ProductphotoRepoImpl extends ProductphotoRepo {
  ...
  override def deleteByIds(productphotoids: Array[ProductphotoId]): ConnectionIO[Int] = {
    sql"""delete from "production"."productphoto" where "productphotoid" = ANY(${fromWrite(productphotoids)(using new Write.Single(ProductphotoId.arrayPut))})""".update.run
  }
  ...
  override def selectByIds(productphotoids: Array[ProductphotoId]): Stream[ConnectionIO, ProductphotoRow] = {
    sql"""select "productphotoid", "thumbnailphoto", "thumbnailphotofilename", "largephoto", "largephotofilename", "modifieddate"::text from "production"."productphoto" where "productphotoid" = ANY(${fromWrite(productphotoids)(using new Write.Single(ProductphotoId.arrayPut))})""".query(using ProductphotoRow.read).stream
  }
