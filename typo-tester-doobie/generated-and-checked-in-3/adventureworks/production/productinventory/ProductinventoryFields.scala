...
trait ProductinventoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductinventoryId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductinventoryId](productid)(_.productid)(using as[Array[ProductId], Required](using ProductId.arrayPut, Write.fromPut(using ProductId.arrayPut)), implicitly), TuplePart[ProductinventoryId](locationid)(_.locationid)(using as[Array[LocationId], Required](using LocationId.arrayPut, Write.fromPut(using LocationId.arrayPut)), implicitly))
