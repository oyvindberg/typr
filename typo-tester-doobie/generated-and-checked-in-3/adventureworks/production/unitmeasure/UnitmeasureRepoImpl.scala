...
class UnitmeasureRepoImpl extends UnitmeasureRepo {
  ...
  def deleteById(unitmeasurecode: UnitmeasureId): ConnectionIO[Boolean] = sql"""delete from "production"."unitmeasure" where "unitmeasurecode" = ${fromWrite(unitmeasurecode)(using new Write.Single(UnitmeasureId.put))}""".update.run.map(_ > 0)

  def deleteByIds(unitmeasurecodes: Array[UnitmeasureId]): ConnectionIO[Int] = sql"""delete from "production"."unitmeasure" where "unitmeasurecode" = ANY(${fromWrite(unitmeasurecodes)(using new Write.Single(UnitmeasureId.arrayPut))})""".update.run
  ...
  def selectById(unitmeasurecode: UnitmeasureId): ConnectionIO[Option[UnitmeasureRow]] = sql"""select "unitmeasurecode", "name", "modifieddate"::text from "production"."unitmeasure" where "unitmeasurecode" = ${fromWrite(unitmeasurecode)(using new Write.Single(UnitmeasureId.put))}""".query(using UnitmeasureRow.read).option

  def selectByIds(unitmeasurecodes: Array[UnitmeasureId]): Stream[ConnectionIO, UnitmeasureRow] = sql"""select "unitmeasurecode", "name", "modifieddate"::text from "production"."unitmeasure" where "unitmeasurecode" = ANY(${fromWrite(unitmeasurecodes)(using new Write.Single(UnitmeasureId.arrayPut))})""".query(using UnitmeasureRow.read).stream
