...
public record UpdatePersonReturningSqlRow(
  ...
  static RowParser<UpdatePersonReturningSqlRow> _rowParser = RowParsers.of(FirstName.pgType, PgTypes.timestamp, (t0, t1) -> new UpdatePersonReturningSqlRow(t0, t1), row -> new Object[]{row.firstname(), row.modifieddate()});;
}