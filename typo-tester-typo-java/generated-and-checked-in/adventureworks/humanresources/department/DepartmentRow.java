...
public record DepartmentRow(
  ...
  static RowParser<DepartmentRow> _rowParser = RowParsers.of(DepartmentId.pgType, Name.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2, t3) -> new DepartmentRow(t0, t1, t2, t3), row -> new Object[]{row.departmentid(), row.name(), row.groupname(), row.modifieddate()});;
