...
public record EmployeepayhistoryRow(
  ...
  static RowParser<EmployeepayhistoryRow> _rowParser = RowParsers.of(BusinessentityId.pgType, PgTypes.timestamp, PgTypes.numeric, PgTypes.int2, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new EmployeepayhistoryRow(t0, t1, t2, t3, t4), row -> new Object[]{row.businessentityid(), row.ratechangedate(), row.rate(), row.payfrequency(), row.modifieddate()});;
