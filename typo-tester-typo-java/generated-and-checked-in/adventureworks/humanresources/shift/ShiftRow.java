...
public record ShiftRow(
  ...
  static RowParser<ShiftRow> _rowParser = RowParsers.of(ShiftId.pgType, Name.pgType, PgTypes.time, PgTypes.time, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new ShiftRow(t0, t1, t2, t3, t4), row -> new Object[]{row.shiftid(), row.name(), row.starttime(), row.endtime(), row.modifieddate()});;
