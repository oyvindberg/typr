...
public record EmployeedepartmenthistoryRepoMock(
  ...
  public Map<EmployeedepartmenthistoryId, EmployeedepartmenthistoryRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((adventureworks.humanresources.employeedepartmenthistory.EmployeedepartmenthistoryRow row) -> row.compositeId(), Function.identity()));
  };
