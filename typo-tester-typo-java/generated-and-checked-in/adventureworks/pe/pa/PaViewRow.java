...
public record PaViewRow(
  ...
  static RowParser<PaViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, PgTypes.text, PgTypes.text, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new PaViewRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.id(), row.businessentityid(), row.passwordhash(), row.passwordsalt(), row.rowguid(), row.modifieddate()});;
}