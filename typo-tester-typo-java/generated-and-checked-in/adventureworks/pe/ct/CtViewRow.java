...
public record CtViewRow(
  ...
  static RowParser<CtViewRow> _rowParser = RowParsers.of(ContacttypeId.pgType, ContacttypeId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2, t3) -> new CtViewRow(t0, t1, t2, t3), row -> new Object[]{row.id(), row.contacttypeid(), row.name(), row.modifieddate()});;
}