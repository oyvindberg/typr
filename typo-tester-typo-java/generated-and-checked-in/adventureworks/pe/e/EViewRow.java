...
public record EViewRow(
  ...
  static RowParser<EViewRow> _rowParser = RowParsers.of(PgTypes.int4, BusinessentityId.pgType, PgTypes.int4, PgTypes.text, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new EViewRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.id(), row.businessentityid(), row.emailaddressid(), row.emailaddress(), row.rowguid(), row.modifieddate()});;
}