...
public record PpViewRow(
  ...
  static RowParser<PpViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, Phone.pgType, PhonenumbertypeId.pgType, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new PpViewRow(t0, t1, t2, t3, t4), row -> new Object[]{row.id(), row.businessentityid(), row.phonenumber(), row.phonenumbertypeid(), row.modifieddate()});;
}