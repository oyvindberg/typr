...
public record BeaViewRow(
  ...
  static RowParser<BeaViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, AddressId.pgType, AddresstypeId.pgType, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new BeaViewRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.id(), row.businessentityid(), row.addressid(), row.addresstypeid(), row.rowguid(), row.modifieddate()});;
}