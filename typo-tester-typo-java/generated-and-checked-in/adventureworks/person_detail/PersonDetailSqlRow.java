...
public record PersonDetailSqlRow(
  ...
  static RowParser<PersonDetailSqlRow> _rowParser = RowParsers.of(BusinessentityId.pgType, PgTypes.text.opt(), FirstName.pgType, Name.pgType.opt(), Name.pgType, PgTypes.text, PgTypes.text.opt(), PgTypes.text.opt(), PgTypes.text.opt(), PgTypes.uuid.opt(), (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) -> new PersonDetailSqlRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9), row -> new Object[]{row.businessentityid(), row.title(), row.firstname(), row.middlename(), row.lastname(), row.jobtitle(), row.addressline1(), row.city(), row.postalcode(), row.rowguid()});;
}