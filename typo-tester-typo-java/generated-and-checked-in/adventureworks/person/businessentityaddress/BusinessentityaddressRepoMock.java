...
public record BusinessentityaddressRepoMock(
  ...
  public Map<BusinessentityaddressId, BusinessentityaddressRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((adventureworks.person.businessentityaddress.BusinessentityaddressRow row) -> row.compositeId(), Function.identity()));
  };
