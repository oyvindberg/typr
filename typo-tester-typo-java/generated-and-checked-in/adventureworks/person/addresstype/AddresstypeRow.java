...
public record AddresstypeRow(
  ...
  static RowParser<AddresstypeRow> _rowParser = RowParsers.of(AddresstypeId.pgType, Name.pgType, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3) -> new AddresstypeRow(t0, t1, t2, t3), row -> new Object[]{row.addresstypeid(), row.name(), row.rowguid(), row.modifieddate()});;
