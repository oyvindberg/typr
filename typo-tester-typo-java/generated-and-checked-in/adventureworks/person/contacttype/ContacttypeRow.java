...
public record ContacttypeRow(
  ...
  static RowParser<ContacttypeRow> _rowParser = RowParsers.of(ContacttypeId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2) -> new ContacttypeRow(t0, t1, t2), row -> new Object[]{row.contacttypeid(), row.name(), row.modifieddate()});;
