...
public record CountryregionRow(
  ...
  static RowParser<CountryregionRow> _rowParser = RowParsers.of(CountryregionId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2) -> new CountryregionRow(t0, t1, t2), row -> new Object[]{row.countryregioncode(), row.name(), row.modifieddate()});;
