...
public record PersonphoneRow(
  ...
  static RowParser<PersonphoneRow> _rowParser = RowParsers.of(BusinessentityId.pgType, Phone.pgType, PhonenumbertypeId.pgType, PgTypes.timestamp, (t0, t1, t2, t3) -> new PersonphoneRow(t0, t1, t2, t3), row -> new Object[]{row.businessentityid(), row.phonenumber(), row.phonenumbertypeid(), row.modifieddate()});;
