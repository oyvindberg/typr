...
public record PhonenumbertypeRow(
  ...
  static RowParser<PhonenumbertypeRow> _rowParser = RowParsers.of(PhonenumbertypeId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2) -> new PhonenumbertypeRow(t0, t1, t2), row -> new Object[]{row.phonenumbertypeid(), row.name(), row.modifieddate()});;
