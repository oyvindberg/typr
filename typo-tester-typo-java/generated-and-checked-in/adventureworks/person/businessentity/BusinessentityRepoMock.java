...
public record BusinessentityRepoMock(
  ...
  public Map<BusinessentityId, BusinessentityRow> selectByIdsTracked(
    ...
    return selectByIds(businessentityids, c).stream().collect(Collectors.toMap((adventureworks.person.businessentity.BusinessentityRow row) -> row.businessentityid(), Function.identity()));
  };
