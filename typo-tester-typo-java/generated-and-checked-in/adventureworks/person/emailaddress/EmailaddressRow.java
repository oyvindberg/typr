...
public record EmailaddressRow(
  ...
  static RowParser<EmailaddressRow> _rowParser = RowParsers.of(BusinessentityId.pgType, PgTypes.int4, PgTypes.text.opt(), PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new EmailaddressRow(t0, t1, t2, t3, t4), row -> new Object[]{row.businessentityid(), row.emailaddressid(), row.emailaddress(), row.rowguid(), row.modifieddate()});;
