...
public record BusinessentitycontactRow(
  ...
  static RowParser<BusinessentitycontactRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, ContacttypeId.pgType, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new BusinessentitycontactRow(t0, t1, t2, t3, t4), row -> new Object[]{row.businessentityid(), row.personid(), row.contacttypeid(), row.rowguid(), row.modifieddate()});;
