...
public record AddressRow(
  ...
  static RowParser<AddressRow> _rowParser = RowParsers.of(AddressId.pgType, PgTypes.text, PgTypes.text.opt(), PgTypes.text, StateprovinceId.pgType, PgTypes.text, PgTypes.bytea.opt(), PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8) -> new AddressRow(t0, t1, t2, t3, t4, t5, t6, t7, t8), row -> new Object[]{row.addressid(), row.addressline1(), row.addressline2(), row.city(), row.stateprovinceid(), row.postalcode(), row.spatiallocation(), row.rowguid(), row.modifieddate()});;
