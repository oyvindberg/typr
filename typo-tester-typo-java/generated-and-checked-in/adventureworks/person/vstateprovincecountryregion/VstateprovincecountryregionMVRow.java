...
public record VstateprovincecountryregionMVRow(
  ...
  static RowParser<VstateprovincecountryregionMVRow> _rowParser = RowParsers.of(StateprovinceId.pgType, PgTypes.bpchar, Flag.pgType, Name.pgType, SalesterritoryId.pgType, CountryregionId.pgType, Name.pgType, (t0, t1, t2, t3, t4, t5, t6) -> new VstateprovincecountryregionMVRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.stateprovinceid(), row.stateprovincecode(), row.isonlystateprovinceflag(), row.stateprovincename(), row.territoryid(), row.countryregioncode(), row.countryregionname()});;
}