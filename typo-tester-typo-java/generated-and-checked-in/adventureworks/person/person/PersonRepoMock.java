...
public record PersonRepoMock(
  ...
  public Map<BusinessentityId, PersonRow> selectByIdsTracked(
    ...
    return selectByIds(businessentityids, c).stream().collect(Collectors.toMap((adventureworks.person.person.PersonRow row) -> row.businessentityid(), Function.identity()));
  };
