...
public record BomViewRow(
  ...
  static RowParser<BomViewRow> _rowParser = RowParsers.of(PgTypes.int4, PgTypes.int4, ProductId.pgType, ProductId.pgType, PgTypes.timestamp, PgTypes.timestamp, UnitmeasureId.pgType, PgTypes.int2, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) -> new BomViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9), row -> new Object[]{row.id(), row.billofmaterialsid(), row.productassemblyid(), row.componentid(), row.startdate(), row.enddate(), row.unitmeasurecode(), row.bomlevel(), row.perassemblyqty(), row.modifieddate()});;
}