...
public record IViewRow(
  ...
  static RowParser<IViewRow> _rowParser = RowParsers.of(IllustrationId.pgType, IllustrationId.pgType, PgTypes.xml, PgTypes.timestamp, (t0, t1, t2, t3) -> new IViewRow(t0, t1, t2, t3), row -> new Object[]{row.id(), row.illustrationid(), row.diagram(), row.modifieddate()});;
}