...
public record DViewRow(
  ...
  static RowParser<DViewRow> _rowParser = RowParsers.of(PgTypes.text, BusinessentityId.pgType, Flag.pgType, PgTypes.text, PgTypes.text, PgTypes.bpchar, PgTypes.int4, PgTypes.int2, PgTypes.text, PgTypes.bytea, PgTypes.uuid, PgTypes.timestamp, DocumentId.pgType, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) -> new DViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12), row -> new Object[]{row.title(), row.owner(), row.folderflag(), row.filename(), row.fileextension(), row.revision(), row.changenumber(), row.status(), row.documentsummary(), row.document(), row.rowguid(), row.modifieddate(), row.documentnode()});;
}