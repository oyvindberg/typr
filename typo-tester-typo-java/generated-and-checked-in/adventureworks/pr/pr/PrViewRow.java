...
public record PrViewRow(
  ...
  static RowParser<PrViewRow> _rowParser = RowParsers.of(ProductreviewId.pgType, ProductreviewId.pgType, ProductId.pgType, Name.pgType, PgTypes.timestamp, PgTypes.text, PgTypes.int4, PgTypes.text, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8) -> new PrViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8), row -> new Object[]{row.id(), row.productreviewid(), row.productid(), row.reviewername(), row.reviewdate(), row.emailaddress(), row.rating(), row.comments(), row.modifieddate()});;
}