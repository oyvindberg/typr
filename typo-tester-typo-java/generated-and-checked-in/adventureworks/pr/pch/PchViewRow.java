...
public record PchViewRow(
  ...
  static RowParser<PchViewRow> _rowParser = RowParsers.of(ProductId.pgType, ProductId.pgType, PgTypes.timestamp, PgTypes.timestamp, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new PchViewRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.id(), row.productid(), row.startdate(), row.enddate(), row.standardcost(), row.modifieddate()});;
}