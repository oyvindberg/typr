...
public record PscViewRow(
  ...
  static RowParser<PscViewRow> _rowParser = RowParsers.of(ProductsubcategoryId.pgType, ProductsubcategoryId.pgType, ProductcategoryId.pgType, Name.pgType, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new PscViewRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.id(), row.productsubcategoryid(), row.productcategoryid(), row.name(), row.rowguid(), row.modifieddate()});;
}