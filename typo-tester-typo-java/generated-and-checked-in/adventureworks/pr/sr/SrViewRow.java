...
public record SrViewRow(
  ...
  static RowParser<SrViewRow> _rowParser = RowParsers.of(ScrapreasonId.pgType, ScrapreasonId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2, t3) -> new SrViewRow(t0, t1, t2, t3), row -> new Object[]{row.id(), row.scrapreasonid(), row.name(), row.modifieddate()});;
}