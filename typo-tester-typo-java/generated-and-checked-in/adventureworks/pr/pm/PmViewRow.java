...
public record PmViewRow(
  ...
  static RowParser<PmViewRow> _rowParser = RowParsers.of(ProductmodelId.pgType, ProductmodelId.pgType, Name.pgType, PgTypes.xml, PgTypes.xml, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new PmViewRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.id(), row.productmodelid(), row.name(), row.catalogdescription(), row.instructions(), row.rowguid(), row.modifieddate()});;
}