...
public record PiViewRow(
  ...
  static RowParser<PiViewRow> _rowParser = RowParsers.of(ProductId.pgType, ProductId.pgType, LocationId.pgType, PgTypes.text, PgTypes.int2, PgTypes.int2, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7) -> new PiViewRow(t0, t1, t2, t3, t4, t5, t6, t7), row -> new Object[]{row.id(), row.productid(), row.locationid(), row.shelf(), row.bin(), row.quantity(), row.rowguid(), row.modifieddate()});;
}