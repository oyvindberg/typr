...
public record UmViewRow(
  ...
  static RowParser<UmViewRow> _rowParser = RowParsers.of(UnitmeasureId.pgType, UnitmeasureId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2, t3) -> new UmViewRow(t0, t1, t2, t3), row -> new Object[]{row.id(), row.unitmeasurecode(), row.name(), row.modifieddate()});;
}