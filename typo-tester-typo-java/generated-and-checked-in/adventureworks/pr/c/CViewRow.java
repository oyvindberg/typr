...
public record CViewRow(
  ...
  static RowParser<CViewRow> _rowParser = RowParsers.of(CultureId.pgType, CultureId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2, t3) -> new CViewRow(t0, t1, t2, t3), row -> new Object[]{row.id(), row.cultureid(), row.name(), row.modifieddate()});;
}