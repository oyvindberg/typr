...
public record PpViewRow(
  ...
  static RowParser<PpViewRow> _rowParser = RowParsers.of(ProductphotoId.pgType, ProductphotoId.pgType, PgTypes.bytea, PgTypes.text, PgTypes.bytea, PgTypes.text, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new PpViewRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.id(), row.productphotoid(), row.thumbnailphoto(), row.thumbnailphotofilename(), row.largephoto(), row.largephotofilename(), row.modifieddate()});;
}