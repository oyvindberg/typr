...
public record ThViewRow(
  ...
  static RowParser<ThViewRow> _rowParser = RowParsers.of(TransactionhistoryId.pgType, TransactionhistoryId.pgType, ProductId.pgType, PgTypes.int4, PgTypes.int4, PgTypes.timestamp, PgTypes.bpchar, PgTypes.int4, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) -> new ThViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9), row -> new Object[]{row.id(), row.transactionid(), row.productid(), row.referenceorderid(), row.referenceorderlineid(), row.transactiondate(), row.transactiontype(), row.quantity(), row.actualcost(), row.modifieddate()});;
}