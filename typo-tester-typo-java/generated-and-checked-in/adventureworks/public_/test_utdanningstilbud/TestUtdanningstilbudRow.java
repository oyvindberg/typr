...
public record TestUtdanningstilbudRow(
  ...
  static RowParser<TestUtdanningstilbudRow> _rowParser = RowParsers.of(TestOrganisasjonId.pgType, PgTypes.text, (t0, t1) -> new TestUtdanningstilbudRow(t0, t1), row -> new Object[]{row.organisasjonskode(), row.utdanningsmulighetKode()});;
