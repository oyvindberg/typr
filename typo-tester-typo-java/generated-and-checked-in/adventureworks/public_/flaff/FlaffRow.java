...
public record FlaffRow(
  ...
  static RowParser<FlaffRow> _rowParser = RowParsers.of(ShortText.pgType, PgTypes.text, PgTypes.int4, ShortText.pgType, ShortText.pgType.opt(), (t0, t1, t2, t3, t4) -> new FlaffRow(t0, t1, t2, t3, t4), row -> new Object[]{row.code(), row.anotherCode(), row.someNumber(), row.specifier(), row.parentspecifier()});;
