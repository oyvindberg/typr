...
public record UsersRow(
  ...
  static RowParser<UsersRow> _rowParser = RowParsers.of(UsersId.pgType, PgTypes.text, PgTypes.text.opt(), PgTypes.unknown, PgTypes.text, PgTypes.timestamptz, PgTypes.timestamptz.opt(), (t0, t1, t2, t3, t4, t5, t6) -> new UsersRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.userId(), row.name(), row.lastName(), row.email(), row.password(), row.createdAt(), row.verifiedOn()});;
