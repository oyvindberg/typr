...
public record TableWithGeneratedColumnsRow(
  ...
  static RowParser<TableWithGeneratedColumnsRow> _rowParser = RowParsers.of(TableWithGeneratedColumnsId.pgType, PgTypes.text, (t0, t1) -> new TableWithGeneratedColumnsRow(t0, t1), row -> new Object[]{row.name(), row.nameTypeAlways()});;
