...
public record ProductinventoryRow(
  ...
  static RowParser<ProductinventoryRow> _rowParser = RowParsers.of(ProductId.pgType, LocationId.pgType, PgTypes.text, PgTypes.int2, PgTypes.int2, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new ProductinventoryRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.productid(), row.locationid(), row.shelf(), row.bin(), row.quantity(), row.rowguid(), row.modifieddate()});;
