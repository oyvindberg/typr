...
public record ProductsubcategoryRow(
  ...
  static RowParser<ProductsubcategoryRow> _rowParser = RowParsers.of(ProductsubcategoryId.pgType, ProductcategoryId.pgType, Name.pgType, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new ProductsubcategoryRow(t0, t1, t2, t3, t4), row -> new Object[]{row.productsubcategoryid(), row.productcategoryid(), row.name(), row.rowguid(), row.modifieddate()});;
