...
public record VproductmodelcatalogdescriptionViewRow(
  ...
  static RowParser<VproductmodelcatalogdescriptionViewRow> _rowParser = RowParsers.of(ProductmodelId.pgType, Name.pgType, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24) -> new VproductmodelcatalogdescriptionViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24), row -> new Object[]{row.productmodelid(), row.name(), row.summary(), row.manufacturer(), row.copyright(), row.producturl(), row.warrantyperiod(), row.warrantydescription(), row.noofyears(), row.maintenancedescription(), row.wheel(), row.saddle(), row.pedal(), row.bikeframe(), row.crankset(), row.pictureangle(), row.picturesize(), row.productphotoid(), row.material(), row.color(), row.productline(), row.style(), row.riderexperience(), row.rowguid(), row.modifieddate()});;
}