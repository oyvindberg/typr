...
public record ProductphotoRow(
  ...
  static RowParser<ProductphotoRow> _rowParser = RowParsers.of(ProductphotoId.pgType, PgTypes.bytea.opt(), PgTypes.text.opt(), PgTypes.bytea.opt(), PgTypes.text.opt(), PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new ProductphotoRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.productphotoid(), row.thumbnailphoto(), row.thumbnailphotofilename(), row.largephoto(), row.largephotofilename(), row.modifieddate()});;
