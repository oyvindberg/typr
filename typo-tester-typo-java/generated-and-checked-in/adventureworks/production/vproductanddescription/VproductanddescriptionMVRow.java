...
public record VproductanddescriptionMVRow(
  ...
  static RowParser<VproductanddescriptionMVRow> _rowParser = RowParsers.of(ProductId.pgType, Name.pgType, Name.pgType, CultureId.pgType, PgTypes.text, (t0, t1, t2, t3, t4) -> new VproductanddescriptionMVRow(t0, t1, t2, t3, t4), row -> new Object[]{row.productid(), row.name(), row.productmodel(), row.cultureid(), row.description()});;
}