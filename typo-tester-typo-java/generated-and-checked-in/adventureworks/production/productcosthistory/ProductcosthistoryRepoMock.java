...
public record ProductcosthistoryRepoMock(
  ...
  public Map<ProductcosthistoryId, ProductcosthistoryRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((adventureworks.production.productcosthistory.ProductcosthistoryRow row) -> row.compositeId(), Function.identity()));
  };
