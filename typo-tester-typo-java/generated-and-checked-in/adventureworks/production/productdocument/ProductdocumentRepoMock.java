...
public record ProductdocumentRepoMock(
  ...
  public Map<ProductdocumentId, ProductdocumentRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((adventureworks.production.productdocument.ProductdocumentRow row) -> row.compositeId(), Function.identity()));
  };
