...
public record TransactionhistoryarchiveRow(
  ...
  static RowParser<TransactionhistoryarchiveRow> _rowParser = RowParsers.of(TransactionhistoryarchiveId.pgType, PgTypes.int4, PgTypes.int4, PgTypes.int4, PgTypes.timestamp, PgTypes.bpchar, PgTypes.int4, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8) -> new TransactionhistoryarchiveRow(t0, t1, t2, t3, t4, t5, t6, t7, t8), row -> new Object[]{row.transactionid(), row.productid(), row.referenceorderid(), row.referenceorderlineid(), row.transactiondate(), row.transactiontype(), row.quantity(), row.actualcost(), row.modifieddate()});;
