...
public record ProductmodelillustrationRepoMock(
  ...
  public Map<ProductmodelillustrationId, ProductmodelillustrationRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((adventureworks.production.productmodelillustration.ProductmodelillustrationRow row) -> row.compositeId(), Function.identity()));
  };
