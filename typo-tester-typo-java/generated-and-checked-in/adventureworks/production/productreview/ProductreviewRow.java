...
public record ProductreviewRow(
  ...
  static RowParser<ProductreviewRow> _rowParser = RowParsers.of(ProductreviewId.pgType, ProductId.pgType, Name.pgType, PgTypes.timestamp, PgTypes.text, PgTypes.int4, PgTypes.text.opt(), PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7) -> new ProductreviewRow(t0, t1, t2, t3, t4, t5, t6, t7), row -> new Object[]{row.productreviewid(), row.productid(), row.reviewername(), row.reviewdate(), row.emailaddress(), row.rating(), row.comments(), row.modifieddate()});;
