...
public record ProductmodelRow(
  ...
  static RowParser<ProductmodelRow> _rowParser = RowParsers.of(ProductmodelId.pgType, Name.pgType, PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new ProductmodelRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.productmodelid(), row.name(), row.catalogdescription(), row.instructions(), row.rowguid(), row.modifieddate()});;
