...
public record IllustrationRow(
  ...
  static RowParser<IllustrationRow> _rowParser = RowParsers.of(IllustrationId.pgType, PgTypes.xml.opt(), PgTypes.timestamp, (t0, t1, t2) -> new IllustrationRow(t0, t1, t2), row -> new Object[]{row.illustrationid(), row.diagram(), row.modifieddate()});;
