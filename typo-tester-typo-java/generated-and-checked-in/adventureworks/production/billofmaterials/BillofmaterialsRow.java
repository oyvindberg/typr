...
public record BillofmaterialsRow(
  ...
  static RowParser<BillofmaterialsRow> _rowParser = RowParsers.of(PgTypes.int4, ProductId.pgType.opt(), ProductId.pgType, PgTypes.timestamp, PgTypes.timestamp.opt(), UnitmeasureId.pgType, PgTypes.int2, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8) -> new BillofmaterialsRow(t0, t1, t2, t3, t4, t5, t6, t7, t8), row -> new Object[]{row.billofmaterialsid(), row.productassemblyid(), row.componentid(), row.startdate(), row.enddate(), row.unitmeasurecode(), row.bomlevel(), row.perassemblyqty(), row.modifieddate()});;
