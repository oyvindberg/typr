...
public record TransactionhistoryRepoMock(
  ...
  public Map<TransactionhistoryId, TransactionhistoryRow> selectByIdsTracked(
    ...
    return selectByIds(transactionids, c).stream().collect(Collectors.toMap((adventureworks.production.transactionhistory.TransactionhistoryRow row) -> row.transactionid(), Function.identity()));
  };
