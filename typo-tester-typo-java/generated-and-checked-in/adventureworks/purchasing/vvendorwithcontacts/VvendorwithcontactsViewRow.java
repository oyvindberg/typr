...
public record VvendorwithcontactsViewRow(
  ...
  static RowParser<VvendorwithcontactsViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, Name.pgType, Name.pgType, PgTypes.text, FirstName.pgType, Name.pgType, Name.pgType, PgTypes.text, Phone.pgType, Name.pgType, PgTypes.text, PgTypes.int4, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) -> new VvendorwithcontactsViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11), row -> new Object[]{row.businessentityid(), row.name(), row.contacttype(), row.title(), row.firstname(), row.middlename(), row.lastname(), row.suffix(), row.phonenumber(), row.phonenumbertype(), row.emailaddress(), row.emailpromotion()});;
}