...
public record ProductvendorRepoMock(
  ...
  public Map<ProductvendorId, ProductvendorRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((adventureworks.purchasing.productvendor.ProductvendorRow row) -> row.compositeId(), Function.identity()));
  };
