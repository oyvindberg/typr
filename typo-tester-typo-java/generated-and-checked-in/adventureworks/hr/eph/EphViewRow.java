...
public record EphViewRow(
  ...
  static RowParser<EphViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, PgTypes.timestamp, PgTypes.numeric, PgTypes.int2, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new EphViewRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.id(), row.businessentityid(), row.ratechangedate(), row.rate(), row.payfrequency(), row.modifieddate()});;
}