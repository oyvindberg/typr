...
public record JcViewRow(
  ...
  static RowParser<JcViewRow> _rowParser = RowParsers.of(JobcandidateId.pgType, JobcandidateId.pgType, BusinessentityId.pgType, PgTypes.xml, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new JcViewRow(t0, t1, t2, t3, t4), row -> new Object[]{row.id(), row.jobcandidateid(), row.businessentityid(), row.resume(), row.modifieddate()});;
}