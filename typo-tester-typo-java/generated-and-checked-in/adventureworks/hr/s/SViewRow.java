...
public record SViewRow(
  ...
  static RowParser<SViewRow> _rowParser = RowParsers.of(ShiftId.pgType, ShiftId.pgType, Name.pgType, PgTypes.time, PgTypes.time, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new SViewRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.id(), row.shiftid(), row.name(), row.starttime(), row.endtime(), row.modifieddate()});;
}