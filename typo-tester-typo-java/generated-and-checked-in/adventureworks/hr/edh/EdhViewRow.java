...
public record EdhViewRow(
  ...
  static RowParser<EdhViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, DepartmentId.pgType, ShiftId.pgType, PgTypes.date, PgTypes.date, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new EdhViewRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.id(), row.businessentityid(), row.departmentid(), row.shiftid(), row.startdate(), row.enddate(), row.modifieddate()});;
}