...
public record SalesreasonRow(
  ...
  static RowParser<SalesreasonRow> _rowParser = RowParsers.of(SalesreasonId.pgType, Name.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2, t3) -> new SalesreasonRow(t0, t1, t2, t3), row -> new Object[]{row.salesreasonid(), row.name(), row.reasontype(), row.modifieddate()});;
