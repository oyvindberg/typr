...
public record SpecialofferRow(
  ...
  static RowParser<SpecialofferRow> _rowParser = RowParsers.of(SpecialofferId.pgType, PgTypes.text, PgTypes.numeric, PgTypes.text, PgTypes.text, PgTypes.timestamp, PgTypes.timestamp, PgTypes.int4, PgTypes.int4.opt(), PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) -> new SpecialofferRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10), row -> new Object[]{row.specialofferid(), row.description(), row.discountpct(), row.type(), row.category(), row.startdate(), row.enddate(), row.minqty(), row.maxqty(), row.rowguid(), row.modifieddate()});;
