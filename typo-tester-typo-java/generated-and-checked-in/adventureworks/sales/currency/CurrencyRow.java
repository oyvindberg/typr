...
public record CurrencyRow(
  ...
  static RowParser<CurrencyRow> _rowParser = RowParsers.of(CurrencyId.pgType, Name.pgType, PgTypes.timestamp, (t0, t1, t2) -> new CurrencyRow(t0, t1, t2), row -> new Object[]{row.currencycode(), row.name(), row.modifieddate()});;
