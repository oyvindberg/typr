...
public record CurrencyrateRow(
  ...
  static RowParser<CurrencyrateRow> _rowParser = RowParsers.of(CurrencyrateId.pgType, PgTypes.timestamp, CurrencyId.pgType, CurrencyId.pgType, PgTypes.numeric, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new CurrencyrateRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.currencyrateid(), row.currencyratedate(), row.fromcurrencycode(), row.tocurrencycode(), row.averagerate(), row.endofdayrate(), row.modifieddate()});;
