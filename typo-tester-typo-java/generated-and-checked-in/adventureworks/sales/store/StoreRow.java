...
public record StoreRow(
  ...
  static RowParser<StoreRow> _rowParser = RowParsers.of(BusinessentityId.pgType, Name.pgType, BusinessentityId.pgType.opt(), PgTypes.xml.opt(), PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new StoreRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.businessentityid(), row.name(), row.salespersonid(), row.demographics(), row.rowguid(), row.modifieddate()});;
