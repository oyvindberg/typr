...
public record SalestaxrateRow(
  ...
  static RowParser<SalestaxrateRow> _rowParser = RowParsers.of(SalestaxrateId.pgType, StateprovinceId.pgType, PgTypes.int2, PgTypes.numeric, Name.pgType, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new SalestaxrateRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.salestaxrateid(), row.stateprovinceid(), row.taxtype(), row.taxrate(), row.name(), row.rowguid(), row.modifieddate()});;
