...
public record PersoncreditcardRepoMock(
  ...
  public Map<PersoncreditcardId, PersoncreditcardRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((adventureworks.sales.personcreditcard.PersoncreditcardRow row) -> row.compositeId(), Function.identity()));
  };
