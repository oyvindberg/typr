...
public record ShoppingcartitemRow(
  ...
  static RowParser<ShoppingcartitemRow> _rowParser = RowParsers.of(ShoppingcartitemId.pgType, PgTypes.text, PgTypes.int4, ProductId.pgType, PgTypes.timestamp, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) -> new ShoppingcartitemRow(t0, t1, t2, t3, t4, t5), row -> new Object[]{row.shoppingcartitemid(), row.shoppingcartid(), row.quantity(), row.productid(), row.datecreated(), row.modifieddate()});;
