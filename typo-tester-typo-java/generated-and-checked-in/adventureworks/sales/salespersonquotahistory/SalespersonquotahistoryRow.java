...
public record SalespersonquotahistoryRow(
  ...
  static RowParser<SalespersonquotahistoryRow> _rowParser = RowParsers.of(BusinessentityId.pgType, PgTypes.timestamp, PgTypes.numeric, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4) -> new SalespersonquotahistoryRow(t0, t1, t2, t3, t4), row -> new Object[]{row.businessentityid(), row.quotadate(), row.salesquota(), row.rowguid(), row.modifieddate()});;
