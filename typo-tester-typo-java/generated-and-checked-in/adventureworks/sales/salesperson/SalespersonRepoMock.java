...
public record SalespersonRepoMock(
  ...
  public Map<BusinessentityId, SalespersonRow> selectByIdsTracked(
    ...
    return selectByIds(businessentityids, c).stream().collect(Collectors.toMap((adventureworks.sales.salesperson.SalespersonRow row) -> row.businessentityid(), Function.identity()));
  };
