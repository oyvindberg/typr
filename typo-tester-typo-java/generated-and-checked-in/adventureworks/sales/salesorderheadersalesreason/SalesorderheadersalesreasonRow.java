...
public record SalesorderheadersalesreasonRow(
  ...
  static RowParser<SalesorderheadersalesreasonRow> _rowParser = RowParsers.of(SalesorderheaderId.pgType, SalesreasonId.pgType, PgTypes.timestamp, (t0, t1, t2) -> new SalesorderheadersalesreasonRow(t0, t1, t2), row -> new Object[]{row.salesorderid(), row.salesreasonid(), row.modifieddate()});;
