...
public record PodViewRow(
  ...
  static RowParser<PodViewRow> _rowParser = RowParsers.of(PgTypes.int4, PurchaseorderheaderId.pgType, PgTypes.int4, PgTypes.timestamp, PgTypes.int2, ProductId.pgType, PgTypes.numeric, PgTypes.numeric, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) -> new PodViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9), row -> new Object[]{row.id(), row.purchaseorderid(), row.purchaseorderdetailid(), row.duedate(), row.orderqty(), row.productid(), row.unitprice(), row.receivedqty(), row.rejectedqty(), row.modifieddate()});;
}