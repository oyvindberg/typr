...
public record PohViewRow(
  ...
  static RowParser<PohViewRow> _rowParser = RowParsers.of(PurchaseorderheaderId.pgType, PurchaseorderheaderId.pgType, PgTypes.int2, PgTypes.int2, BusinessentityId.pgType, BusinessentityId.pgType, ShipmethodId.pgType, PgTypes.timestamp, PgTypes.timestamp, PgTypes.numeric, PgTypes.numeric, PgTypes.numeric, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) -> new PohViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12), row -> new Object[]{row.id(), row.purchaseorderid(), row.revisionnumber(), row.status(), row.employeeid(), row.vendorid(), row.shipmethodid(), row.orderdate(), row.shipdate(), row.subtotal(), row.taxamt(), row.freight(), row.modifieddate()});;
}