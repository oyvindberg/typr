...
public record SViewRow(
  ...
  static RowParser<SViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, Name.pgType, BusinessentityId.pgType, PgTypes.xml, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new SViewRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.id(), row.businessentityid(), row.name(), row.salespersonid(), row.demographics(), row.rowguid(), row.modifieddate()});;
}