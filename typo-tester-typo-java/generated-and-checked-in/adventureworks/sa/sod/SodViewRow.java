...
public record SodViewRow(
  ...
  static RowParser<SodViewRow> _rowParser = RowParsers.of(PgTypes.int4, SalesorderheaderId.pgType, PgTypes.int4, PgTypes.text, PgTypes.int2, ProductId.pgType, SpecialofferId.pgType, PgTypes.numeric, PgTypes.numeric, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) -> new SodViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10), row -> new Object[]{row.id(), row.salesorderid(), row.salesorderdetailid(), row.carriertrackingnumber(), row.orderqty(), row.productid(), row.specialofferid(), row.unitprice(), row.unitpricediscount(), row.rowguid(), row.modifieddate()});;
}