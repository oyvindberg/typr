...
public record SpViewRow(
  ...
  static RowParser<SpViewRow> _rowParser = RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, SalesterritoryId.pgType, PgTypes.numeric, PgTypes.numeric, PgTypes.numeric, PgTypes.numeric, PgTypes.numeric, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) -> new SpViewRow(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9), row -> new Object[]{row.id(), row.businessentityid(), row.territoryid(), row.salesquota(), row.bonus(), row.commissionpct(), row.salesytd(), row.saleslastyear(), row.rowguid(), row.modifieddate()});;
}