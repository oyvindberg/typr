...
public record CViewRow(
  ...
  static RowParser<CViewRow> _rowParser = RowParsers.of(CustomerId.pgType, CustomerId.pgType, BusinessentityId.pgType, BusinessentityId.pgType, SalesterritoryId.pgType, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new CViewRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.id(), row.customerid(), row.personid(), row.storeid(), row.territoryid(), row.rowguid(), row.modifieddate()});;
}