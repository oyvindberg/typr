...
public record SciViewRow(
  ...
  static RowParser<SciViewRow> _rowParser = RowParsers.of(ShoppingcartitemId.pgType, ShoppingcartitemId.pgType, PgTypes.text, PgTypes.int4, ProductId.pgType, PgTypes.timestamp, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) -> new SciViewRow(t0, t1, t2, t3, t4, t5, t6), row -> new Object[]{row.id(), row.shoppingcartitemid(), row.shoppingcartid(), row.quantity(), row.productid(), row.datecreated(), row.modifieddate()});;
}