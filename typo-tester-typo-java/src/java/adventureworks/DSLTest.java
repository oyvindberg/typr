          ...
          var query =
              personRepoImpl
                  ...
                  .map(
                      ...
                      p ->
                          p.lastname()
                              .includeIf(new SqlExpr.ConstReq<>(true, typo.runtime.PgTypes.bool)));
          ...
          var query =
              personRepoImpl
                  ...
                  .map(
                      ...
                      p ->
                          p.lastname()
                              .includeIf(new SqlExpr.ConstReq<>(false, typo.runtime.PgTypes.bool)));
          ...
          var query =
              personRepoImpl
                  ...
                  .having(
                      p ->
                          SqlExpr.count()
                              .greaterThan(new SqlExpr.ConstReq<>(1L, typo.runtime.PgTypes.int8)))
                  .select(p -> Tuples.of(p.persontype(), SqlExpr.count()));
