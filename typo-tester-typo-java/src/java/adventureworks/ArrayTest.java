...
public class ArrayTest {
  ...
  static PgtestnullRow pgtestnullRowWithValues() {
    return new PgtestnullRow(
        ...
        Optional.of(new LocalTime[] {LocalTime.now()}),
        Optional.of(new LocalDateTime[] {LocalDateTime.now()}),
        Optional.of(new Instant[] {Instant.now()}),
        Optional.of(new OffsetTime[] {OffsetTime.now()}),
