...
public record EmployeeRepoMock(
  ...
  public Map<EmployeeId, EmployeeRow> selectByIdsTracked(
    ...
    return selectByIds(ids, c).stream().collect(Collectors.toMap((frontpage.frontpage.employee.EmployeeRow row) -> row.id(), Function.identity()));
  };
  ...
  public Optional<EmployeeRow> selectByUniquePersonId(
    ...
    return new ArrayList<>(map.values()).stream().filter(v -> personId.equals(v.personId())).findFirst();
  };
