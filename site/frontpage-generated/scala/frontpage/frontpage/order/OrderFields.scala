...
object OrderFields {
  ...
  private final class Impl(val _path: List[Path])
    ...
    override lazy val columns: List[FieldLike[?, OrderRow]] =
      List[FieldLike[?, OrderRow]](fields.id, fields.userId, fields.productId, fields.status, fields.total, fields.createdAt, fields.shippedAt)
