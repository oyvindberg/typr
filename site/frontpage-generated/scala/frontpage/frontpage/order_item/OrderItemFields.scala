...
object OrderItemFields {
  ...
  private final class Impl(val _path: List[Path])
    ...
    override lazy val columns: List[FieldLike[?, OrderItemRow]] =
      List[FieldLike[?, OrderItemRow]](fields.id, fields.orderId, fields.productId, fields.quantity, fields.price, fields.shippedAt)
