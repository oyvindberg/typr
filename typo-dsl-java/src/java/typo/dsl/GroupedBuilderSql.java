...
public class GroupedBuilderSql<Fields, Row> implements GroupedBuilder<Fields, Row> {
  ...
  static class GroupedSelectBuilderSql<
    ...
    @Override
    public <Fields2, Row2>
        SelectBuilder<typo.dsl.Tuple2<NewFields, Fields2>, typo.dsl.Tuple2<NewRow, Row2>> joinOn(
            SelectBuilder<Fields2, Row2> other,
            Function<typo.dsl.Tuple2<NewFields, Fields2>, SqlExpr<Boolean>> pred) {
    ...
    @Override
    public <Fields2, Row2>
        SelectBuilder<typo.dsl.Tuple2<NewFields, Fields2>, typo.dsl.Tuple2<NewRow, Optional<Row2>>>
            leftJoinOn(
                SelectBuilder<Fields2, Row2> other,
                Function<typo.dsl.Tuple2<NewFields, Fields2>, SqlExpr<Boolean>> pred) {
      if (!(other instanceof SelectBuilderSql<Fields2, Row2> otherSql)) {
    ...
    @Override
    public <Fields2, Row2>
        SelectBuilder<typo.dsl.Tuple2<NewFields, Fields2>, typo.dsl.Tuple2<NewRow, List<Row2>>>
            multisetOn(
                SelectBuilder<Fields2, Row2> other,
                Function<typo.dsl.Tuple2<NewFields, Fields2>, SqlExpr<Boolean>> pred) {
      if (!(other instanceof SelectBuilderSql<Fields2, Row2> otherSql)) {
  ...
  public record SyntheticField<T>(typo.runtime.DbType<T> pgType, String column, String tableAlias)
