...
/**
 * Implementation of SQL LIKE pattern matching.
 * Converts SQL LIKE patterns to Java regex patterns.
 */
public class Like {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (c == escapeChar) {
                if (i == sqlPattern.length() - 1) {
                    throw new IllegalArgumentException("Invalid escape sequence: " + sqlPattern + " at position " + i);
                }
