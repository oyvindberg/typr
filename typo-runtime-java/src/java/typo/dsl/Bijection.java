...
public interface Bijection<T, TT> {
   ...
   *
   * <p>This is used for type-safe boolean operations on {@link typo.dsl.SqlExpr}. The method only
   ...
   *
   * <p>This is used for type-safe string operations on {@link typo.dsl.SqlExpr}. The method only
