...
public class streamingInsert {
    public static <T> long insertUnchecked(String copyCommand, int batchSize, Iterator<T> rows, Connection c, PgText<T> T) {
        try {
    ...
    public static <T> long insert(String copyCommand, int batchSize, Iterator<T> rows, Connection c, PgText<T> T) throws SQLException {
