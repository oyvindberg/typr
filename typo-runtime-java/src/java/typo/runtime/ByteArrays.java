...
/**
 * Utility methods for converting between primitive byte[] and boxed Byte[] arrays.
 * This is needed because Java records typically use boxed Byte[] while JDBC uses primitive byte[].
 */
