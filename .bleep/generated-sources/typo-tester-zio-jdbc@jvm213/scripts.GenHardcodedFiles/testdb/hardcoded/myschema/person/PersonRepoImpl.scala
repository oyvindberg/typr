...
class PersonRepoImpl extends PersonRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, PersonRow] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person"""".query(PersonRow.jdbcDecoder).selectStream()
  ...
  def selectById(id: PersonId): ZIO[ZConnection, Throwable, Option[PersonRow]] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person" where "id" = ${Segment.paramSegment(id)(PersonId.setter)}""".query(PersonRow.jdbcDecoder).selectOne
