...
class MaritalStatusRepoImpl extends MaritalStatusRepo {
  ...
  def selectAll: ZStream[ZConnection, Throwable, MaritalStatusRow] = sql"""select "id" from "myschema"."marital_status"""".query(MaritalStatusRow.jdbcDecoder).selectStream()
  ...
  def selectById(id: MaritalStatusId): ZIO[ZConnection, Throwable, Option[MaritalStatusRow]] = sql"""select "id" from "myschema"."marital_status" where "id" = ${Segment.paramSegment(id)(MaritalStatusId.setter)}""".query(MaritalStatusRow.jdbcDecoder).selectOne

  def selectByIds(ids: Array[MaritalStatusId]): ZStream[ZConnection, Throwable, MaritalStatusRow] = sql"""select "id" from "myschema"."marital_status" where "id" = ANY(${Segment.paramSegment(ids)(MaritalStatusId.arraySetter)})""".query(MaritalStatusRow.jdbcDecoder).selectStream()
