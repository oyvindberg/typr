...
public record PersonRepoImpl() implements PersonRepo {
  ...
  public List<PersonRow> selectByFieldValues(
        ...
        fieldValues.stream().map(
          fv -> switch (fv) {
                  case id x -> interpolate(
                    ...
                    "id" = 
                    """),
                    PersonId.pgType.encode(x.value()),
                    typo.runtime.Fragment.lit("")
                  );
                  case favouriteFootballClubId x -> interpolate(
                    typo.runtime.Fragment.lit("""
                  ...
                  case nickName x -> interpolate(
                    typo.runtime.Fragment.lit("""
                    "nick_name" = 
                    """),
                    PgTypes.text.opt().encode(x.value()),
                    typo.runtime.Fragment.lit("")
                  );
                  case blogUrl x -> interpolate(
                    typo.runtime.Fragment.lit("""
                    "blog_url" = 
                    """),
                    PgTypes.text.opt().encode(x.value()),
                  ...
                  case likesPizza x -> interpolate(
                    typo.runtime.Fragment.lit("""
                    "likes_pizza" = 
                    """),
                    PgTypes.bool.encode(x.value()),
                    typo.runtime.Fragment.lit("")
                  );
                  case maritalStatusId x -> interpolate(
                    typo.runtime.Fragment.lit("""
                    "marital_status_id" = 
                    """),
                  ...
                  case sector x -> interpolate(
                    typo.runtime.Fragment.lit("""
                    "sector" = 
                    """),
                    Sector.pgType.encode(x.value()),
                    typo.runtime.Fragment.lit("")
                  );
                  case favoriteNumber x -> interpolate(
                    typo.runtime.Fragment.lit("""
                    "favorite_number" = 
                    """),
                    Number.pgType.encode(x.value()),
                    typo.runtime.Fragment.lit("")
                  );
                }
        ).toList()
    ...
    return interpolate(
             typo.runtime.Fragment.lit("""
             select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person" 
             """),
             where,
             typo.runtime.Fragment.lit("")
           ).as(PersonRow._rowParser.all()).runUnchecked(c);
