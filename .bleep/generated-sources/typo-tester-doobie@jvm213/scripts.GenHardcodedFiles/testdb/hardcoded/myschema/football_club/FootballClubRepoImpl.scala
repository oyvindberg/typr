...
class FootballClubRepoImpl extends FootballClubRepo {
  def delete: DeleteBuilder[FootballClubFields, FootballClubRow] = DeleteBuilder.of(""""myschema"."football_club"""", FootballClubFields.structure, FootballClubRow.read)

  def deleteById(id: FootballClubId): ConnectionIO[Boolean] = sql"""delete from "myschema"."football_club" where "id" = ${fromWrite(id)(new Write.Single(FootballClubId.put))}""".update.run.map(_ > 0)

  def deleteByIds(ids: Array[FootballClubId]): ConnectionIO[Int] = sql"""delete from "myschema"."football_club" where "id" = ANY(${fromWrite(ids)(new Write.Single(FootballClubId.arrayPut))})""".update.run
  ...
  def select: SelectBuilder[FootballClubFields, FootballClubRow] = SelectBuilder.of(""""myschema"."football_club"""", FootballClubFields.structure, FootballClubRow.read)

  def selectAll: Stream[ConnectionIO, FootballClubRow] = sql"""select "id", "name" from "myschema"."football_club"""".query(FootballClubRow.read).stream
  ...
  def selectById(id: FootballClubId): ConnectionIO[Option[FootballClubRow]] = sql"""select "id", "name" from "myschema"."football_club" where "id" = ${fromWrite(id)(new Write.Single(FootballClubId.put))}""".query(FootballClubRow.read).option

  def selectByIds(ids: Array[FootballClubId]): Stream[ConnectionIO, FootballClubRow] = sql"""select "id", "name" from "myschema"."football_club" where "id" = ANY(${fromWrite(ids)(new Write.Single(FootballClubId.arrayPut))})""".query(FootballClubRow.read).stream
  ...
  def update: UpdateBuilder[FootballClubFields, FootballClubRow] = UpdateBuilder.of(""""myschema"."football_club"""", FootballClubFields.structure, FootballClubRow.read)
