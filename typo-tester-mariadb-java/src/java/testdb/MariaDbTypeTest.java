    ...
    WithConnection.run(
        c -> {
          ...
          assertEquals(
              ...
              mariatestnullRepo
                  .select()
                  .where(p -> p.boolCol().isEqual(row.boolCol().orElse(null)))
                  .toList(c)
                  .get(0)
                  .boolCol());
          assertEquals(
              ...
              mariatestnullRepo
                  .select()
                  .where(p -> p.varcharCol().isEqual(row.varcharCol().orElse(null)))
                  .toList(c)
                  .get(0)
                  .varcharCol());
          assertEquals(
              ...
              mariatestnullRepo
                  .select()
                  .where(p -> p.intCol().isEqual(row.intCol().orElse(null)))
                  .toList(c)
                  .get(0)
                  .intCol());
          assertEquals(
              ...
              mariatestnullRepo
                  .select()
                  .where(p -> p.bigintCol().isEqual(row.bigintCol().orElse(null)))
                  .toList(c)
                  .get(0)
                  .bigintCol());
          assertEquals(
              ...
              mariatestnullRepo
                  .select()
                  .where(p -> p.dateCol().isEqual(row.dateCol().orElse(null)))
                  .toList(c)
                  .get(0)
                  .dateCol());
          assertEquals(
              ...
              mariatestnullRepo
                  .select()
                  .where(p -> p.yearCol().isEqual(row.yearCol().orElse(null)))
                  .toList(c)
                  .get(0)
                  .yearCol());
          assertEquals(
              ...
              mariatestnullRepo
                  .select()
                  .where(p -> p.enumCol().isEqual(row.enumCol().orElse(null)))
                  .toList(c)
                  .get(0)
                  .enumCol());
        });
  ...
  public void canQueryMariatestWithDSL() {
    WithConnection.run(
        c -> {
          ...
          mariatestRepo
              .update()
              .setValue(p -> p.boolCol(), row.boolCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.varcharCol(), row.varcharCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.textCol(), row.textCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.bigintCol(), row.bigintCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.dateCol(), row.dateCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.timeCol(), row.timeCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.yearCol(), row.yearCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.enumCol(), row.enumCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
          mariatestRepo
              .update()
              .setValue(p -> p.jsonCol(), row.jsonCol())
              .where(p -> p.intCol().isEqual(row.intCol()))
              .execute(c);
        });
  }
