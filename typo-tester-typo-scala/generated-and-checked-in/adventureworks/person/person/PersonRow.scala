...
object PersonRow {
  val `_rowParser`: RowParser[PersonRow] = {
    RowParsers.of(BusinessentityId.pgType, PgTypes.text, NameStyle.pgType, PgTypes.text.opt(), /* user-picked */ FirstName.pgType, Name.pgType.opt(), Name.pgType, PgTypes.text.opt(), PgTypes.int4, TypoXml.pgType.opt(), TypoXml.pgType.opt(), TypoUUID.pgType, TypoLocalDateTime.pgType, PersonRow.apply, row => new Tuple13(
