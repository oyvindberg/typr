...
object VstateprovincecountryregionMVRow {
  val `_rowParser`: RowParser[VstateprovincecountryregionMVRow] = {
    RowParsers.of(StateprovinceId.pgType, PgTypes.text, Flag.pgType, Name.pgType, SalesterritoryId.pgType, CountryregionId.pgType, Name.pgType, VstateprovincecountryregionMVRow.apply, row => new Tuple7(
      row.stateprovinceid,
