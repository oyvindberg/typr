...
object StateprovinceRowUnsaved {
  given pgText: PgText[StateprovinceRowUnsaved] = {
    PgText.instance((row, sb) => {
      ...
      sb.append(PgText.DELIMETER);
      Defaulted.pgText(using StateprovinceId.pgType.pgText).unsafeEncode(row.stateprovinceid, sb);
      sb.append(PgText.DELIMETER);
      Defaulted.pgText(using Flag.pgType.pgText).unsafeEncode(row.isonlystateprovinceflag, sb);
      sb.append(PgText.DELIMETER);
