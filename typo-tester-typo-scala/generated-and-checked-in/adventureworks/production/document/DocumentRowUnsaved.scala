...
object DocumentRowUnsaved {
  given pgText: PgText[DocumentRowUnsaved] = {
    PgText.instance((row, sb) => {
      ...
      sb.append(PgText.DELIMETER);
      Defaulted.pgText(using Flag.pgType.pgText).unsafeEncode(row.folderflag, sb);
      sb.append(PgText.DELIMETER);
      Defaulted.pgText(using PgTypes.int4.pgText).unsafeEncode(row.changenumber, sb);
      sb.append(PgText.DELIMETER);
