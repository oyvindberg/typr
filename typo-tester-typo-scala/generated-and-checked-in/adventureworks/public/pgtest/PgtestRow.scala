...
object PgtestRow {
  val `_rowParser`: RowParser[PgtestRow] = {
    RowParsers.of(PgTypes.bool, TypoBox.pgType, PgTypes.text, TypoBytea.pgType, PgTypes.text, TypoCircle.pgType, TypoLocalDate.pgType, PgTypes.float4, PgTypes.float8, TypoHStore.pgType, TypoInet.pgType, TypoShort.pgType, TypoInt2Vector.pgType, PgTypes.int4, PgTypes.int8, TypoInterval.pgType, TypoJson.pgType, TypoJsonb.pgType, TypoLine.pgType, TypoLineSegment.pgType, TypoMoney.pgType, Mydomain.pgType, Myenum.pgType, PgTypes.text, PgTypes.numeric, TypoPath.pgType, TypoPoint.pgType, TypoPolygon.pgType, PgTypes.text, TypoLocalTime.pgType, TypoLocalDateTime.pgType, TypoInstant.pgType, TypoOffsetTime.pgType, TypoUUID.pgType, PgTypes.text, TypoVector.pgType, TypoXml.pgType, TypoBox.pgTypeArray, PgTypes.textArray, PgTypes.textArray, TypoCircle.pgTypeArray, TypoLocalDate.pgTypeArray, PgTypes.float4Array, PgTypes.float8Array, TypoInet.pgTypeArray, TypoShort.pgTypeArray, TypoInt2Vector.pgTypeArray, PgTypes.int4Array, PgTypes.int8Array, TypoInterval.pgTypeArray, TypoJson.pgTypeArray, TypoJsonb.pgTypeArray, TypoLine.pgTypeArray, TypoLineSegment.pgTypeArray, TypoMoney.pgTypeArray, Mydomain.pgTypeArray, Myenum.pgTypeArray, PgTypes.textArray, PgTypes.numericArray, TypoPath.pgTypeArray, TypoPoint.pgTypeArray, TypoPolygon.pgTypeArray, PgTypes.textArray, TypoLocalTime.pgTypeArray, TypoLocalDateTime.pgTypeArray, TypoInstant.pgTypeArray, TypoOffsetTime.pgTypeArray, TypoUUID.pgTypeArray, PgTypes.textArray, TypoXml.pgTypeArray, PgtestRow.apply, row => new Tuple70(
      row.bool,
      row.box,
      row.bpchar,
      row.bytea,
