...
class MariatestnullRepoImpl() : MariatestnullRepo {
  ...
  override fun insert(
    ...
    unsaved.tinyintCol.visit(
      ...
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.tinyint.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.smallintCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`smallint_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.smallint.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.mediumintCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`mediumint_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.mediumint.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.intCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`int_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.int_.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.bigintCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`bigint_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.bigint.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.tinyintUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`tinyint_u_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.tinyintUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.smallintUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`smallint_u_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.smallintUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.mediumintUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`mediumint_u_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.mediumintUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.intUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`int_u_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.intUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.bigintUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`bigint_u_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.bigintUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.decimalCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`decimal_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.numeric.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.floatCol.visit(
      ...
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.float_.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.doubleCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`double_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.double_.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.boolCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`bool_col`"))
      values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.bool.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.bitCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`bit_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.bit.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.charCol.visit(
      ...
      values.add(interpolate(Fragment.encode(MariaTypes.char_.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.textCol.visit(
      ...
      values.add(interpolate(Fragment.encode(MariaTypes.text.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.mediumtextCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`mediumtext_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.mediumtext.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.longtextCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`longtext_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.longtext.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.binaryCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`binary_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.binary.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.varbinaryCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`varbinary_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.varbinary.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.tinyblobCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`tinyblob_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.tinyblob.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.blobCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`blob_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.blob.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.mediumblobCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`mediumblob_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.mediumblob.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.longblobCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`longblob_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.longblob.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.dateCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`date_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.date.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.timeCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`time_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.time.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.timestampCol.visit(
      ...
      values.add(interpolate(Fragment.encode(MariaTypes.timestamp.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.yearCol.visit(
      ...
      values.add(interpolate(Fragment.encode(MariaTypes.year.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.setCol.visit(
      ...
      values.add(interpolate(Fragment.encode(MariaTypes.set.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.inet4Col.visit(
      ...
      values.add(interpolate(Fragment.encode(MariaTypes.inet4.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.inet6Col.visit(
      {  },
      { value -> columns.add(Fragment.lit("`inet6_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.inet6.nullable(), value), Fragment.lit(""))) }
    );
    val q: Fragment = (if (columns.isEmpty()) interpolate(Fragment.lit("insert into `mariatestnull` default values\nreturning `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`\n")) else interpolate(Fragment.lit("insert into `mariatestnull`("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`\n")))
  ...
  override fun selectAll(c: Connection): List<MariatestnullRow> = interpolate(Fragment.lit("select `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`\nfrom `mariatestnull`\n")).query(MariatestnullRow._rowParser.all()).runUnchecked(c)
