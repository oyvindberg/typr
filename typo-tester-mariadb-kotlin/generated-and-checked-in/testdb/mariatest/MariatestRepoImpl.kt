...
class MariatestRepoImpl() : MariatestRepo {
  ...
  override fun deleteById(
    intCol: MariatestId,
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from `mariatest` where `int_col` = "), Fragment.encode(MariatestId.pgType, intCol), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.tinyint, unsaved.tinyintCol), Fragment.lit("")))
    columns.add(Fragment.lit("`smallint_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.smallint, unsaved.smallintCol), Fragment.lit("")))
    columns.add(Fragment.lit("`mediumint_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.mediumint, unsaved.mediumintCol), Fragment.lit("")))
    ...
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.bigint, unsaved.bigintCol), Fragment.lit("")))
    columns.add(Fragment.lit("`tinyint_u_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.tinyintUnsigned, unsaved.tinyintUCol), Fragment.lit("")))
    columns.add(Fragment.lit("`smallint_u_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.smallintUnsigned, unsaved.smallintUCol), Fragment.lit("")))
    columns.add(Fragment.lit("`mediumint_u_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.mediumintUnsigned, unsaved.mediumintUCol), Fragment.lit("")))
    columns.add(Fragment.lit("`int_u_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.intUnsigned, unsaved.intUCol), Fragment.lit("")))
    ...
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.numeric, unsaved.decimalCol), Fragment.lit("")))
    columns.add(Fragment.lit("`numeric_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.numeric, unsaved.numericCol), Fragment.lit("")))
    columns.add(Fragment.lit("`float_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.float_, unsaved.floatCol), Fragment.lit("")))
    columns.add(Fragment.lit("`double_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.double_, unsaved.doubleCol), Fragment.lit("")))
    columns.add(Fragment.lit("`bool_col`"))
    values.add(interpolate(Fragment.encode(KotlinDbTypes.MariaTypes.bool, unsaved.boolCol), Fragment.lit("")))
    ...
    val q: Fragment = interpolate(Fragment.lit("insert into `mariatest`("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`\n"))
  ...
  override fun selectAll(c: Connection): List<MariatestRow> = interpolate(Fragment.lit("select `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`\nfrom `mariatest`\n")).query(MariatestRow._rowParser.all()).runUnchecked(c)

  override fun selectById(
    intCol: MariatestId,
    c: Connection
  ): MariatestRow? = interpolate(Fragment.lit("select `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`\nfrom `mariatest`\nwhere `int_col` = "), Fragment.encode(MariatestId.pgType, intCol), Fragment.lit("")).query(MariatestRow._rowParser.first()).runUnchecked(c)
  ...
  override fun upsertBatch(
    ...
    c: Connection
  ): List<MariatestRow> = interpolate(Fragment.lit("INSERT INTO `mariatest`(`tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`)\nVALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)\nON DUPLICATE KEY UPDATE `tinyint_col` = VALUES(`tinyint_col`),\n`smallint_col` = VALUES(`smallint_col`),\n`mediumint_col` = VALUES(`mediumint_col`),\n`bigint_col` = VALUES(`bigint_col`),\n`tinyint_u_col` = VALUES(`tinyint_u_col`),\n`smallint_u_col` = VALUES(`smallint_u_col`),\n`mediumint_u_col` = VALUES(`mediumint_u_col`),\n`int_u_col` = VALUES(`int_u_col`),\n`bigint_u_col` = VALUES(`bigint_u_col`),\n`decimal_col` = VALUES(`decimal_col`),\n`numeric_col` = VALUES(`numeric_col`),\n`float_col` = VALUES(`float_col`),\n`double_col` = VALUES(`double_col`),\n`bool_col` = VALUES(`bool_col`),\n`bit_col` = VALUES(`bit_col`),\n`bit1_col` = VALUES(`bit1_col`),\n`char_col` = VALUES(`char_col`),\n`varchar_col` = VALUES(`varchar_col`),\n`tinytext_col` = VALUES(`tinytext_col`),\n`text_col` = VALUES(`text_col`),\n`mediumtext_col` = VALUES(`mediumtext_col`),\n`longtext_col` = VALUES(`longtext_col`),\n`binary_col` = VALUES(`binary_col`),\n`varbinary_col` = VALUES(`varbinary_col`),\n`tinyblob_col` = VALUES(`tinyblob_col`),\n`blob_col` = VALUES(`blob_col`),\n`mediumblob_col` = VALUES(`mediumblob_col`),\n`longblob_col` = VALUES(`longblob_col`),\n`date_col` = VALUES(`date_col`),\n`time_col` = VALUES(`time_col`),\n`time_fsp_col` = VALUES(`time_fsp_col`),\n`datetime_col` = VALUES(`datetime_col`),\n`datetime_fsp_col` = VALUES(`datetime_fsp_col`),\n`timestamp_col` = VALUES(`timestamp_col`),\n`timestamp_fsp_col` = VALUES(`timestamp_fsp_col`),\n`year_col` = VALUES(`year_col`),\n`enum_col` = VALUES(`enum_col`),\n`set_col` = VALUES(`set_col`),\n`json_col` = VALUES(`json_col`),\n`inet4_col` = VALUES(`inet4_col`),\n`inet6_col` = VALUES(`inet6_col`)\nRETURNING `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `enum_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col`"))
