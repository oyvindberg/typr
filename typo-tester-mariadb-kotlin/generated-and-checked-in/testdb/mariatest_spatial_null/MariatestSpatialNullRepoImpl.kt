...
class MariatestSpatialNullRepoImpl() : MariatestSpatialNullRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = interpolate(Fragment.lit("delete from `mariatest_spatial_null` where `id` = "), Fragment.encode(MariatestSpatialNullId.pgType, id), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    unsaved.geometryCol.visit(
      ...
      values.add(interpolate(Fragment.encode(MariaTypes.geometry.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.pointCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`point_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.point.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.linestringCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`linestring_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.linestring.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.polygonCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`polygon_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.polygon.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.multipointCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`multipoint_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.multipoint.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.multilinestringCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`multilinestring_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.multilinestring.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.multipolygonCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`multipolygon_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.multipolygon.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.geometrycollectionCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`geometrycollection_col`"))
      values.add(interpolate(Fragment.encode(MariaTypes.geometrycollection.nullable(), value), Fragment.lit(""))) }
    );
    val q: Fragment = (if (columns.isEmpty()) interpolate(Fragment.lit("insert into `mariatest_spatial_null` default values\nreturning `id`, `geometry_col`, `point_col`, `linestring_col`, `polygon_col`, `multipoint_col`, `multilinestring_col`, `multipolygon_col`, `geometrycollection_col`\n")) else interpolate(Fragment.lit("insert into `mariatest_spatial_null`("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning `id`, `geometry_col`, `point_col`, `linestring_col`, `polygon_col`, `multipoint_col`, `multilinestring_col`, `multipolygon_col`, `geometrycollection_col`\n")))
  ...
  override fun selectAll(c: Connection): List<MariatestSpatialNullRow> = interpolate(Fragment.lit("select `id`, `geometry_col`, `point_col`, `linestring_col`, `polygon_col`, `multipoint_col`, `multilinestring_col`, `multipolygon_col`, `geometrycollection_col`\nfrom `mariatest_spatial_null`\n")).query(MariatestSpatialNullRow._rowParser.all()).runUnchecked(c)

  override fun selectById(
    id: MariatestSpatialNullId,
    c: Connection
  ): MariatestSpatialNullRow? = interpolate(Fragment.lit("select `id`, `geometry_col`, `point_col`, `linestring_col`, `polygon_col`, `multipoint_col`, `multilinestring_col`, `multipolygon_col`, `geometrycollection_col`\nfrom `mariatest_spatial_null`\nwhere `id` = "), Fragment.encode(MariatestSpatialNullId.pgType, id), Fragment.lit("")).query(MariatestSpatialNullRow._rowParser.first()).runUnchecked(c)
  ...
  override fun upsertBatch(
    ...
    c: Connection
  ): List<MariatestSpatialNullRow> = interpolate(Fragment.lit("INSERT INTO `mariatest_spatial_null`(`id`, `geometry_col`, `point_col`, `linestring_col`, `polygon_col`, `multipoint_col`, `multilinestring_col`, `multipolygon_col`, `geometrycollection_col`)\nVALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)\nON DUPLICATE KEY UPDATE `geometry_col` = VALUES(`geometry_col`),\n`point_col` = VALUES(`point_col`),\n`linestring_col` = VALUES(`linestring_col`),\n`polygon_col` = VALUES(`polygon_col`),\n`multipoint_col` = VALUES(`multipoint_col`),\n`multilinestring_col` = VALUES(`multilinestring_col`),\n`multipolygon_col` = VALUES(`multipolygon_col`),\n`geometrycollection_col` = VALUES(`geometrycollection_col`)\nRETURNING `id`, `geometry_col`, `point_col`, `linestring_col`, `polygon_col`, `multipoint_col`, `multilinestring_col`, `multipolygon_col`, `geometrycollection_col`"))
