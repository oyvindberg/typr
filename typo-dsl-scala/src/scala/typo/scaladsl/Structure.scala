...
/** Top-level type alias for RelationStructure interface.
  ...
  *   - columns(): java.util.List[typo.dsl.SqlExpr.FieldLike[?, Row]] (from FieldsExpr)
  *   - _path(): java.util.List[typo.dsl.Path] (from RelationStructure)
  *   - copy(_path: java.util.List[typo.dsl.Path]): RelationStructure[Fields, Row] (from RelationStructure)
  *
  ...
  */
type RelationStructure[Fields, Row] = typo.dsl.RelationStructure[Fields, Row]
