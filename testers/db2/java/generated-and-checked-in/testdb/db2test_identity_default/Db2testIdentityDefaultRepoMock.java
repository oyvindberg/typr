...
public record Db2testIdentityDefaultRepoMock(
  ...
  public Db2testIdentityDefaultRepoMock(
      java.util.function.Function<Db2testIdentityDefaultRowUnsaved, Db2testIdentityDefaultRow>
          toRow) {
    this(toRow, new HashMap<Db2testIdentityDefaultId, Db2testIdentityDefaultRow>());
  }
  ;

  public Db2testIdentityDefaultRepoMock withToRow(
      java.util.function.Function<Db2testIdentityDefaultRowUnsaved, Db2testIdentityDefaultRow>
          toRow) {
  ...
  public Db2testIdentityDefaultRepoMock withMap(
      HashMap<Db2testIdentityDefaultId, Db2testIdentityDefaultRow> map) {
    return new Db2testIdentityDefaultRepoMock(toRow, map);
  }
  ;
  ...
  public Map<Db2testIdentityDefaultId, Db2testIdentityDefaultRow> selectByIdsTracked(
    ...
    return selectByIds(ids, c).stream()
        .collect(
            Collectors.toMap((Db2testIdentityDefaultRow row) -> row.id(), Function.identity()));
  }
  ;
