...
class Db2testUniqueRepoImpl() : Db2testUniqueRepo {
  ...
  override fun deleteById(
    id: Db2testUniqueId,
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"DB2TEST_UNIQUE\" where \"ID\" = "), Fragment.encode(Db2testUniqueId.pgType, id), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in ids) { fragments.add(Fragment.encode(Db2testUniqueId.pgType, id)) }
  ...
  override fun selectById(
    id: Db2testUniqueId,
    c: Connection
  ): Db2testUniqueRow? = Fragment.interpolate(Fragment.lit("select \"ID\", \"EMAIL\", \"CODE\", \"CATEGORY\"\nfrom \"DB2TEST_UNIQUE\"\nwhere \"ID\" = "), Fragment.encode(Db2testUniqueId.pgType, id), Fragment.lit("")).query(Db2testUniqueRow._rowParser.first()).runUnchecked(c)
  ...
  override fun upsert(
    ...
    Fragment.interpolate(Fragment.lit("MERGE INTO \"DB2TEST_UNIQUE\" AS t\nUSING (VALUES ("), Fragment.encode(Db2Types.varchar, unsaved.email), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.code), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.category), Fragment.lit(")) AS s(\"EMAIL\", \"CODE\", \"CATEGORY\")\nON t.\"ID\" = s.\"ID\"\nWHEN MATCHED THEN UPDATE SET \"EMAIL\" = s.\"EMAIL\",\n\"CODE\" = s.\"CODE\",\n\"CATEGORY\" = s.\"CATEGORY\"\nWHEN NOT MATCHED THEN INSERT (\"EMAIL\", \"CODE\", \"CATEGORY\") VALUES ("), Fragment.encode(Db2Types.varchar, unsaved.email), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.code), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.category), Fragment.lit(")"))
      .update()
      .runUnchecked(c)
  }
