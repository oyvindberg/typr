...
class DistinctTypeTestRepoImpl() : DistinctTypeTestRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"DISTINCT_TYPE_TEST\" where \"ID\" = "), Fragment.encode(DistinctTypeTestId.pgType, id), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in ids) { fragments.add(Fragment.encode(DistinctTypeTestId.pgType, id)) }
  ...
  override fun insert(
    ...
    c: Connection
  ): DistinctTypeTestRow = Fragment.interpolate(Fragment.lit("SELECT \"ID\", \"EMAIL\", \"BALANCE\" FROM FINAL TABLE (INSERT INTO \"DISTINCT_TYPE_TEST\"(\"EMAIL\", \"BALANCE\")\nVALUES ("), Fragment.encode(EmailAddress.pgType, unsaved.email), Fragment.lit(", "), Fragment.encode(MoneyAmount.pgType.nullable(), unsaved.balance), Fragment.lit("))\n"))
  ...
  override fun insert(
    ...
    values.add(Fragment.interpolate(Fragment.encode(EmailAddress.pgType, unsaved.email), Fragment.lit("")))
    columns.add(Fragment.lit("\"BALANCE\""))
    values.add(Fragment.interpolate(Fragment.encode(MoneyAmount.pgType.nullable(), unsaved.balance), Fragment.lit("")))
  ...
  override fun selectById(
    id: DistinctTypeTestId,
    c: Connection
  ): DistinctTypeTestRow? = Fragment.interpolate(Fragment.lit("select \"ID\", \"EMAIL\", \"BALANCE\"\nfrom \"DISTINCT_TYPE_TEST\"\nwhere \"ID\" = "), Fragment.encode(DistinctTypeTestId.pgType, id), Fragment.lit("")).query(DistinctTypeTestRow._rowParser.first()).runUnchecked(c)
  ...
  override fun update(
    ...
    return Fragment.interpolate(Fragment.lit("update \"DISTINCT_TYPE_TEST\"\nset \"EMAIL\" = "), Fragment.encode(EmailAddress.pgType, row.email), Fragment.lit(",\n\"BALANCE\" = "), Fragment.encode(MoneyAmount.pgType.nullable(), row.balance), Fragment.lit("\nwhere \"ID\" = "), Fragment.encode(DistinctTypeTestId.pgType, id), Fragment.lit("")).update().runUnchecked(c) > 0
  }
  ...
  override fun upsert(
    ...
    Fragment.interpolate(Fragment.lit("MERGE INTO \"DISTINCT_TYPE_TEST\" AS t\nUSING (VALUES ("), Fragment.encode(EmailAddress.pgType, unsaved.email), Fragment.lit(", "), Fragment.encode(MoneyAmount.pgType.nullable(), unsaved.balance), Fragment.lit(")) AS s(\"EMAIL\", \"BALANCE\")\nON t.\"ID\" = s.\"ID\"\nWHEN MATCHED THEN UPDATE SET \"EMAIL\" = s.\"EMAIL\",\n\"BALANCE\" = s.\"BALANCE\"\nWHEN NOT MATCHED THEN INSERT (\"EMAIL\", \"BALANCE\") VALUES ("), Fragment.encode(EmailAddress.pgType, unsaved.email), Fragment.lit(", "), Fragment.encode(MoneyAmount.pgType.nullable(), unsaved.balance), Fragment.lit(")"))
      .update()
      .runUnchecked(c)
  }
