...
class Db2testIdentityAlwaysRepoImpl() : Db2testIdentityAlwaysRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"DB2TEST_IDENTITY_ALWAYS\" where \"ID\" = "), Fragment.encode(Db2testIdentityAlwaysId.pgType, id), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in ids) { fragments.add(Fragment.encode(Db2testIdentityAlwaysId.pgType, id)) }
  ...
  override fun selectById(
    id: Db2testIdentityAlwaysId,
    c: Connection
  ): Db2testIdentityAlwaysRow? = Fragment.interpolate(Fragment.lit("select \"ID\", \"NAME\"\nfrom \"DB2TEST_IDENTITY_ALWAYS\"\nwhere \"ID\" = "), Fragment.encode(Db2testIdentityAlwaysId.pgType, id), Fragment.lit("")).query(Db2testIdentityAlwaysRow._rowParser.first()).runUnchecked(c)
