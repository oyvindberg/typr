...
class CustomersRepoImpl() : CustomersRepo {
  ...
  override fun insert(
    ...
    c: Connection
  ): CustomersRow = Fragment.interpolate(Fragment.lit("SELECT \"CUSTOMER_ID\", \"NAME\", \"EMAIL\", \"CREATED_AT\" FROM FINAL TABLE (INSERT INTO \"CUSTOMERS\"(\"CUSTOMER_ID\", \"NAME\", \"EMAIL\", \"CREATED_AT\")\nVALUES ("), Fragment.encode(CustomersId.pgType, unsaved.customerId), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.name), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.email), Fragment.lit(", "), Fragment.encode(Db2Types.timestamp.nullable(), unsaved.createdAt), Fragment.lit("))\n"))
  ...
  override fun insert(
    ...
    unsaved.customerId.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(CustomersId.pgType, value), Fragment.lit(""))) }
    );
  ...
  override fun upsert(
    ...
    Fragment.interpolate(Fragment.lit("MERGE INTO \"CUSTOMERS\" AS t\nUSING (VALUES ("), Fragment.encode(CustomersId.pgType, unsaved.customerId), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.name), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.email), Fragment.lit(", "), Fragment.encode(Db2Types.timestamp.nullable(), unsaved.createdAt), Fragment.lit(")) AS s(\"CUSTOMER_ID\", \"NAME\", \"EMAIL\", \"CREATED_AT\")\nON t.\"CUSTOMER_ID\" = s.\"CUSTOMER_ID\"\nWHEN MATCHED THEN UPDATE SET \"NAME\" = s.\"NAME\",\n\"EMAIL\" = s.\"EMAIL\",\n\"CREATED_AT\" = s.\"CREATED_AT\"\nWHEN NOT MATCHED THEN INSERT (\"CUSTOMER_ID\", \"NAME\", \"EMAIL\", \"CREATED_AT\") VALUES ("), Fragment.encode(CustomersId.pgType, unsaved.customerId), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.name), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.email), Fragment.lit(", "), Fragment.encode(Db2Types.timestamp.nullable(), unsaved.createdAt), Fragment.lit(")"))
      .update()
      .runUnchecked(c)
  }
