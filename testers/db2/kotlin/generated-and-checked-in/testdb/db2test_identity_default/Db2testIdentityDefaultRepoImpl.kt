...
class Db2testIdentityDefaultRepoImpl() : Db2testIdentityDefaultRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"DB2TEST_IDENTITY_DEFAULT\" where \"ID\" = "), Fragment.encode(Db2testIdentityDefaultId.pgType, id), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in ids) { fragments.add(Fragment.encode(Db2testIdentityDefaultId.pgType, id)) }
  ...
  override fun insert(
    ...
    c: Connection
  ): Db2testIdentityDefaultRow = Fragment.interpolate(Fragment.lit("SELECT \"ID\", \"NAME\" FROM FINAL TABLE (INSERT INTO \"DB2TEST_IDENTITY_DEFAULT\"(\"ID\", \"NAME\")\nVALUES ("), Fragment.encode(Db2testIdentityDefaultId.pgType, unsaved.id), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.name), Fragment.lit("))\n"))
  ...
  override fun insert(
    ...
    unsaved.id.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(Db2testIdentityDefaultId.pgType, value), Fragment.lit(""))) }
    );
  ...
  override fun selectById(
    id: Db2testIdentityDefaultId,
    c: Connection
  ): Db2testIdentityDefaultRow? = Fragment.interpolate(Fragment.lit("select \"ID\", \"NAME\"\nfrom \"DB2TEST_IDENTITY_DEFAULT\"\nwhere \"ID\" = "), Fragment.encode(Db2testIdentityDefaultId.pgType, id), Fragment.lit("")).query(Db2testIdentityDefaultRow._rowParser.first()).runUnchecked(c)
  ...
  override fun upsert(
    ...
    Fragment.interpolate(Fragment.lit("MERGE INTO \"DB2TEST_IDENTITY_DEFAULT\" AS t\nUSING (VALUES ("), Fragment.encode(Db2testIdentityDefaultId.pgType, unsaved.id), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.name), Fragment.lit(")) AS s(\"ID\", \"NAME\")\nON t.\"ID\" = s.\"ID\"\nWHEN MATCHED THEN UPDATE SET \"NAME\" = s.\"NAME\"\nWHEN NOT MATCHED THEN INSERT (\"ID\", \"NAME\") VALUES ("), Fragment.encode(Db2testIdentityDefaultId.pgType, unsaved.id), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.name), Fragment.lit(")"))
      .update()
      .runUnchecked(c)
  }
