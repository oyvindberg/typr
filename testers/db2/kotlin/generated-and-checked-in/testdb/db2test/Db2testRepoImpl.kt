...
class Db2testRepoImpl() : Db2testRepo {
  ...
  override fun deleteById(
    intCol: Db2testId,
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"DB2TEST\" where \"INT_COL\" = "), Fragment.encode(Db2testId.dbType, intCol), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in intCols) { fragments.add(Fragment.encode(Db2testId.dbType, id)) }
  ...
  override fun selectById(
    intCol: Db2testId,
    c: Connection
  ): Db2testRow? = Fragment.interpolate(Fragment.lit("select \"SMALLINT_COL\", \"INT_COL\", \"BIGINT_COL\", \"DECIMAL_COL\", \"NUMERIC_COL\", \"DECFLOAT16_COL\", \"DECFLOAT34_COL\", \"REAL_COL\", \"DOUBLE_COL\", \"BOOL_COL\", \"CHAR_COL\", \"VARCHAR_COL\", \"CLOB_COL\", \"GRAPHIC_COL\", \"VARGRAPHIC_COL\", \"BINARY_COL\", \"VARBINARY_COL\", \"BLOB_COL\", \"DATE_COL\", \"TIME_COL\", \"TIMESTAMP_COL\", \"TIMESTAMP6_COL\", \"TIMESTAMP12_COL\", \"XML_COL\"\nfrom \"DB2TEST\"\nwhere \"INT_COL\" = "), Fragment.encode(Db2testId.dbType, intCol), Fragment.lit("")).query(Db2testRow._rowParser.first()).runUnchecked(c)
