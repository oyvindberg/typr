...
class OrderItemsRepoImpl() : OrderItemsRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"ORDER_ITEMS\" where \"ORDER_ID\" = "), Fragment.encode(OrdersId.pgType, compositeId.orderId), Fragment.lit(" AND \"ITEM_NUMBER\" = "), Fragment.encode(KotlinDbTypes.Db2Types.integer, compositeId.itemNumber), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in compositeIds) { fragments.add(Fragment.interpolate(Fragment.lit("("), Fragment.encode(OrdersId.pgType, id.orderId), Fragment.lit(", "), Fragment.encode(KotlinDbTypes.Db2Types.integer, id.itemNumber), Fragment.lit(")"))) }
  ...
  override fun selectById(
    compositeId: OrderItemsId,
    c: Connection
  ): OrderItemsRow? = Fragment.interpolate(Fragment.lit("select \"ORDER_ID\", \"ITEM_NUMBER\", \"PRODUCT_NAME\", \"QUANTITY\", \"UNIT_PRICE\"\nfrom \"ORDER_ITEMS\"\nwhere \"ORDER_ID\" = "), Fragment.encode(OrdersId.pgType, compositeId.orderId), Fragment.lit(" AND \"ITEM_NUMBER\" = "), Fragment.encode(KotlinDbTypes.Db2Types.integer, compositeId.itemNumber), Fragment.lit("")).query(OrderItemsRow._rowParser.first()).runUnchecked(c)
  ...
  override fun upsert(
    ...
    Fragment.interpolate(Fragment.lit("MERGE INTO \"ORDER_ITEMS\" AS t\nUSING (VALUES ("), Fragment.encode(OrdersId.pgType, unsaved.orderId), Fragment.lit(", "), Fragment.encode(KotlinDbTypes.Db2Types.integer, unsaved.itemNumber), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.productName), Fragment.lit(", "), Fragment.encode(KotlinDbTypes.Db2Types.integer, unsaved.quantity), Fragment.lit(", "), Fragment.encode(KotlinDbTypes.Db2Types.decimal, unsaved.unitPrice), Fragment.lit(")) AS s(\"ORDER_ID\", \"ITEM_NUMBER\", \"PRODUCT_NAME\", \"QUANTITY\", \"UNIT_PRICE\")\nON t.\"ORDER_ID\" = s.\"ORDER_ID\" AND t.\"ITEM_NUMBER\" = s.\"ITEM_NUMBER\"\nWHEN MATCHED THEN UPDATE SET \"PRODUCT_NAME\" = s.\"PRODUCT_NAME\",\n\"QUANTITY\" = s.\"QUANTITY\",\n\"UNIT_PRICE\" = s.\"UNIT_PRICE\"\nWHEN NOT MATCHED THEN INSERT (\"ORDER_ID\", \"ITEM_NUMBER\", \"PRODUCT_NAME\", \"QUANTITY\", \"UNIT_PRICE\") VALUES ("), Fragment.encode(OrdersId.pgType, unsaved.orderId), Fragment.lit(", "), Fragment.encode(KotlinDbTypes.Db2Types.integer, unsaved.itemNumber), Fragment.lit(", "), Fragment.encode(Db2Types.varchar, unsaved.productName), Fragment.lit(", "), Fragment.encode(KotlinDbTypes.Db2Types.integer, unsaved.quantity), Fragment.lit(", "), Fragment.encode(KotlinDbTypes.Db2Types.decimal, unsaved.unitPrice), Fragment.lit(")"))
      .update()
      .runUnchecked(c)
  }
