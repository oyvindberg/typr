...
data class ProductRowUnsaved(
  ...
  companion object {
    val pgText: PgText<ProductRowUnsaved> =
      ...
      sb.append(PgText.DELIMETER)
      UnitmeasureId.dbType.nullable().text().unsafeEncode(row.sizeunitmeasurecode, sb)
      sb.append(PgText.DELIMETER)
      UnitmeasureId.dbType.nullable().text().unsafeEncode(row.weightunitmeasurecode, sb)
      sb.append(PgText.DELIMETER)
      ...
      sb.append(PgText.DELIMETER)
      ProductsubcategoryId.dbType.nullable().text().unsafeEncode(row.productsubcategoryid, sb)
      sb.append(PgText.DELIMETER)
      ProductmodelId.dbType.nullable().text().unsafeEncode(row.productmodelid, sb)
      sb.append(PgText.DELIMETER)
