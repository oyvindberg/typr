...
class ProductRepoImpl() : ProductRepo {
  ...
  override fun deleteById(
    productid: ProductId,
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"production\".\"product\" where \"productid\" = "), Fragment.encode(ProductId.dbType, productid), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(Fragment.interpolate(Fragment.encode(UnitmeasureId.dbType.nullable(), unsaved.sizeunitmeasurecode), Fragment.lit("::bpchar")))
    columns.add(Fragment.lit("\"weightunitmeasurecode\""))
    values.add(Fragment.interpolate(Fragment.encode(UnitmeasureId.dbType.nullable(), unsaved.weightunitmeasurecode), Fragment.lit("::bpchar")))
    ...
    values.add(Fragment.interpolate(Fragment.encode(ProductsubcategoryId.dbType.nullable(), unsaved.productsubcategoryid), Fragment.lit("::int4")))
    columns.add(Fragment.lit("\"productmodelid\""))
    values.add(Fragment.interpolate(Fragment.encode(ProductmodelId.dbType.nullable(), unsaved.productmodelid), Fragment.lit("::int4")))
    ...
    unsaved.productid.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(ProductId.dbType, value), Fragment.lit("::int4"))) }
    );
    unsaved.makeflag.visit(
      {  },
      { value -> columns.add(Fragment.lit("\"makeflag\""))
      values.add(Fragment.interpolate(Fragment.encode(Flag.dbType, value), Fragment.lit("::bool"))) }
    );
