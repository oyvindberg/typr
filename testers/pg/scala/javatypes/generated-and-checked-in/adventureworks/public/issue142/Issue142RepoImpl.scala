...
class Issue142RepoImpl extends Issue142Repo {
  ...
  override def deleteById(tabellkode: Issue142Id)(using c: Connection): java.lang.Boolean = interpolate(Fragment.lit("""delete from "public"."issue142" where "tabellkode" = """), Fragment.encode(Issue142Id.dbType, tabellkode), Fragment.lit("")).update().runUnchecked(c) > 0
