...
class MariatestRepoImpl() : MariatestRepo {
  ...
  override fun deleteById(
    intCol: MariatestId,
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from `mariatest` where `int_col` = "), Fragment.encode(MariatestId.dbType, intCol), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in intCols) { fragments.add(Fragment.encode(MariatestId.dbType, id)) }
  ...
  override fun insert(
    ...
    values.add(Fragment.interpolate(Fragment.encode(MariatestId.dbType, unsaved.intCol), Fragment.lit("")))
    ...
    values.add(Fragment.interpolate(Fragment.encode(XYZSet.dbType, unsaved.setCol), Fragment.lit("")))
