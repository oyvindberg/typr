...
class ShipmentsRepoImpl() : ShipmentsRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from `shipments` where `shipment_id` = "), Fragment.encode(ShipmentsId.dbType, shipmentId), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in shipmentIds) { fragments.add(Fragment.encode(ShipmentsId.dbType, id)) }
  ...
  override fun insert(
    ...
    values.add(Fragment.interpolate(Fragment.encode(ShippingCarriersId.dbType, unsaved.carrierId), Fragment.lit("")))
    ...
    unsaved.originWarehouseId.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(WarehousesId.dbType.nullable(), value), Fragment.lit(""))) }
    );
