...
class OrdersRepoImpl() : OrdersRepo {
  ...
  override fun insert(
    ...
    unsaved.shippingAddressId.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(CustomerAddressesId.dbType.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.promotionId.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(PromotionsId.dbType.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.notes.visit(
      {  },
