...
class ProductsRepoImpl() : ProductsRepo {
  ...
  override fun deleteById(
    ...
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from `products` where `product_id` = "), Fragment.encode(ProductsId.dbType, productId), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun deleteByIds(
    ...
    for (id in productIds) { fragments.add(Fragment.encode(ProductsId.dbType, id)) }
  ...
  override fun insert(
    ...
    unsaved.brandId.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(BrandsId.dbType.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.tags.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(BestsellerClearanceFSet.dbType.nullable(), value), Fragment.lit(""))) }
    );
