...
/**
 * Integration tests for the OpenAPI generated Java JAX-RS server and JDK HTTP client code. These
 * tests start a real Grizzly/Jersey server and use the generated client.
 */
public class OpenApiIntegrationTest {
  ...
  /**
   * Test server implementation - @Path annotation required because Jersey doesn't inherit
   * class-level annotations from interfaces
   */
